    ...
    public:
        ...
        void RunAutomaticTests()
        {
            // Spin Barrier
            {
                ...
                TEST(100==BarrierData2[0], "SpinBarrierThread1")
                TEST(100==BarrierData2[1], "SpinBarrierThread2")
                TEST(100==BarrierData2[2], "SpinBarrierThread3")
                TEST(100==BarrierData2[3], "SpinBarrierThread4")
            }

            {

                const Int32 TestCount = 1000;
                SpinBarrier StartStressBarrier(5); // One more than threads launch because the main thread
                SpinBarrier EndStressBarrier(5);
                Int32 DataToCopy = 0;
                ...
                TEST(CheckResults(StorageForZero), "ThreadCounterOffInThread0Spin");
                TEST(CheckResults(StorageForOne), "ThreadCounterOffInThread1Spin");
                TEST(CheckResults(StorageForTwo), "ThreadCounterOffInThread2Spin");
                TEST(CheckResults(StorageForThree), "ThreadCounterOffInThread3Spin");
            }
            ...
            // Background Barrier
            {
                ...
                TEST(100==BarrierData2[0], "BackgroundBarrierThread1")
                TEST(100==BarrierData2[1], "BackgroundBarrierThread2")
                TEST(100==BarrierData2[2], "BackgroundBarrierThread3")
                TEST(100==BarrierData2[3], "BackgroundBarrierThread4")
            }

            {
                ...
                TEST(CheckResults(StorageForZero), "ThreadCounterOffInThread0Background");
                TEST(CheckResults(StorageForOne), "ThreadCounterOffInThread1Background");
                TEST(CheckResults(StorageForTwo), "ThreadCounterOffInThread2Background");
                TEST(CheckResults(StorageForThree), "ThreadCounterOffInThread3Background");
            }
