...
struct ArmadilloOptions
{
        vector<String> LoadList;                    ///< Log files to load
};
...
/// @param
/// @return
ArmadilloOptions ParseCommandLineOption(int argc, char** argv)
{
    ArmadilloOptions Results;
    try
    {
        TCLAP::CmdLine cmd("Armadillo - Mezzanine Multithreaded log tool", ' ', "0.01");

        TCLAP::MultiArg<String> LoadArg("f", "file", "A file to read.", false, "filename", cmd);
...
int main (int argc, char** argv)
{
    ...
    ArmadilloOptions Options=ParseCommandLineOption(argc, argv);
