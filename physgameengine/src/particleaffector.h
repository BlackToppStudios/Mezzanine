...
#ifndef _particleaffector_h
#define _particleaffector_h
...
namespace phys
{
    ...
    class PHYS_LIB ParticleAffector
    {
        protected:
            ...
            ParticleAffector(Ogre::ParticleAffector* InternalAffector);
        public:
