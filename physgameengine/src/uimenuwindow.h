    ...
    namespace UI
    {
        ...
        class PHYS_LIB MenuWindow : public Window
        {
            ...
            public:
                ...
                /// @param Text The text to set for the button.
                /// @return Returns a pointer to the created Back Button.
                virtual TextButton* CreateBackButton(const Vector2& Position, const Vector2& Size, const Real& LineHeight, const String& Text);
                ...
                /// @param LineHeight The lineheight you want the text to have in relative units.  This will automatically select the glyph and scale it for you.
                /// @param Text The text to set for the button.
                virtual TextButton* CreateAccessorButton(ConstString& Name, const Vector2& Position, const Vector2& Size, const Real& LineHeight, const String& Text);
