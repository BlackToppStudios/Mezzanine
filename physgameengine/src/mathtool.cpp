...
namespace phys
{
    ...
    Real MathTool::Cos(Real Radians)
    {
        return cos(Radians);
    }

    Real MathTool::Sin(Real Radians)
    {
        return sin(Radians);
    }

    Real MathTool::Tan(Real Radians)
    {
        return tan(Radians);
    }

    Real MathTool::ACos(Real Interval)
    {
        return acos(Interval);
    }

    Real MathTool::ASin(Real Interval)
    {
        return asin(Interval);
    }

    Real MathTool::ATan(Real Interval)
    {
