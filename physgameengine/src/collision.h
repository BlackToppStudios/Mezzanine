...
/// @brief Serializes the passed phys::Collision to XML
/// @param stream The ostream to send the xml to.
/// @param Col the phys::Collision to be serialized
/// @return this returns the ostream, now with the serialized data
std::ostream& PHYS_LIB operator << (std::ostream& stream, const phys::Collision& Col);

/// @brief Deserialize a phys::Collision
/// @param stream The istream to get the xml from to (re)make the phys::Collision.
/// @param Col the phys::Collision to be deserialized.
/// @return this returns the ostream, advanced past the phys::Collision that was recreated onto Ev.
std::istream& PHYS_LIB operator >> (std::istream& stream, phys::Collision& Col);

/// @brief Set all values of a phys::Collision from parsed xml.
/// @param OneNode The istream to get the xml from to (re)make the phys::Collision.
/// @param Col the phys::Collision to be reset.
/// @return This returns the xml::Node that was passed in.
void PHYS_LIB operator >> (const phys::xml::Node& OneNode, phys::Collision& Col);
