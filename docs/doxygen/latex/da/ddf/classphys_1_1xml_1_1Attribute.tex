...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000048}{Todo}]update this to make the error return code redudant and use an exception instead. \end{Desc}
...
\end{DoxyWarning}
\begin{Desc}
\item[\hyperlink{todo__todo000042}{Todo}]Strip \char`\"{}$>$\char`\"{} automatically and provide a method to reconsitute it. \end{Desc}
