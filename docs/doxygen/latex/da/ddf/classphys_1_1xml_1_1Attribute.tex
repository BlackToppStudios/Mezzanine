...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000043}{Todo}]update this to make the error return code redudant and use an exception instead. 
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000042}{Todo}]update this to make the error return code redudant and use an exception instead. 
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000041}{Todo}]update this to make the error return code redudant and use an exception instead. 
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000044}{Todo}]update this to make the error return code redudant and use an exception instead. 
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000040}{Todo}]update this to make the error return code redudant and use an exception instead. 
