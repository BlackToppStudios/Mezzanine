...
\subsubsection[{GetWorldPointer}]{\setlength{\rightskip}{0pt plus 5cm}{\bf World} $\ast$ phys::World::GetWorldPointer ()\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
\subsubsection[{Log}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T $>$ void PHYS\_\-LIB phys::World::Log (T {\em Message})\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{LogString}]{\setlength{\rightskip}{0pt plus 5cm}void phys::World::LogString (const {\bf String} \& {\em message})}}
