...
\begin{Desc}
\item[\hyperlink{todo__todo000018}{Todo}]TODO: adjust the constructors to allow for pointers to a callback manager and event manager \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000017}{Todo}]TODO Fix the `const`ness of all methods to be as const as allowable \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000022}{Todo}]TODO Change the name of an application once it is running \end{Desc}
