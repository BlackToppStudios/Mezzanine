...
\begin{DoxyCompactList}\small\item\em This is the core of the Ogre rendering system. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
...
Definition at line 641 of file world.cpp.
...
Even thought the largest part of ogre is 3d rendering, it does not belong in the graphics manager. It is also responsible for a large number other services, such as logging, multithreading, and timing. 

Return a pointer to the world \begin{DoxyReturn}{Returns}
...
\begin{Desc}
\item[\hyperlink{todo__todo000037}{Todo}]TODO Change the name of an application once it is running \end{Desc}
