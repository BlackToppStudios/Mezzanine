...
\begin{DoxyCompactList}\small\item\em Runtime \hyperlink{classphys_1_1Event}{Event} logging Function. \item\end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em This is the default pointer to the \hyperlink{classphys_1_1Event}{Event} Manager. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Friends}
\begin{DoxyCompactItemize}
\item 
...
This Tears down all the items create by the physworld, and safely frees any graphical resources, we will also delete any Objects passed into the Physworld by pointer. We will not delete any pointers we pass out (like from the Events from the \hyperlink{classphys_1_1Event}{Event} manager) 
...
Runtime \hyperlink{classphys_1_1Event}{Event} logging Function. 
...
Definition at line 441 of file world.cpp.
...
This is the default pointer to the \hyperlink{classphys_1_1Event}{Event} Manager. 

This is the \hyperlink{classphys_1_1Event}{Event} manager that all physworld members will place any events into. 
