...
{\footnotesize template$<$class T $>$ }\\void PHYS\_\-LIB \hyperlink{classphys_1_1World_a115b287bc8a23dfdf314f715a818e293}{Log} (T Message)
...
\item[{std::string}]{ SceneManagerName, }
...
\item[{\em GeographyLowerBounds\_\-}]The lower limits for the size of the physics simulation \item[{\em GeographyUpperbounds\_\-}]The Upper limits for the size of the physics simulation \item[{\em MaxPhysicsProxies\_\-}]This is the amount of Actors (Also called Proxies) allowed in a physics simulation. \item[{\em SceneManagerName}]An unique indentifier for the scene manager \item[{\em SceneType}]A cue to the scenemanager as to how rendering should occur. \item[{\em LogFileName}]This is the place that log messages get sent to. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em GeographyLowerBounds\_\-}]The lower limits for the size of the physics simulation \item[{\em GeographyUpperbounds\_\-}]The Upper limits for the size of the physics simulation \item[{\em MaxPhysicsProxies\_\-}]This is the amount of Actors (Also called Proxies) allowed in a physics simulation. \item[{\em LogFileName}]This is the place that log messages get sent to. \item[{\em SceneManagerName}]An unique indentifier for the scene manager \item[{\em SceneType}]A cue to the scenemanager as to how rendering should occur. \item[{\em ManagerToBeAdded}]This is a vector of manager pointers that will be used instead of creating new ones \end{DoxyParams}
\begin{DoxyWarning}{Warning}
Do not make a new world if one already exists. This can only cause problems. 
\end{DoxyWarning}
...
Definition at line 643 of file world.cpp.
...
Definition at line 461 of file world.cpp.
...
\hypertarget{classphys_1_1World_a115b287bc8a23dfdf314f715a818e293}{
\index{phys::World@{phys::World}!Log@{Log}}
\index{Log@{Log}!phys::World@{phys::World}}
\subsubsection[{Log}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T $>$ void PHYS\_\-LIB phys::World::Log (
\begin{DoxyParamCaption}
\item[{T}]{ Message}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
\label{da/ddf/classphys_1_1World_a115b287bc8a23dfdf314f715a818e293}
...
This is the preferred way to throw an exception. It streams any thrown object to the log. 
...
Definition at line 481 of file world.cpp.
...
\begin{Desc}
\item[\hyperlink{todo__todo000034}{Todo}]TODO Change the name of an application once it is running \end{Desc}
