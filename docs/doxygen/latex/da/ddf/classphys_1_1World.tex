...
\begin{DoxyParams}{Parameters}
\item[{\em GeographyLowerBounds\_\-}]The lower limits for the size of the physics simulation \item[{\em GeographyUpperbounds\_\-}]The Upper limits for the size of the physics simulation \item[{\em MaxPhysicsProxies\_\-}]This is the amount of Actors (Also called Proxies) allowed in a physics simulation. \item[{\em LogFileName}]This is the place that log messages get sent to. \item[{\em SceneType}]A cue to the scenemanager as to how rendering should occur. \item[{\em ManagerToBeAdded}]This is a vector of manager pointers that will be used instead of creating new ones \end{DoxyParams}
\begin{DoxyWarning}{Warning}
Do not make a new world if one already exists. This can only cause problems. 
\end{DoxyWarning}
...
Definition at line 212 of file world.cpp.
...
\paragraph[{GetActorManager}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ActorContainerBase} $\ast$ phys::World::GetActorManager (
\begin{DoxyParamCaption}
...
Definition at line 490 of file world.cpp.
...
Definition at line 576 of file world.cpp.
...
Definition at line 581 of file world.cpp.
...
Definition at line 399 of file world.cpp.
...
\begin{DoxyParams}{Parameters}
\item[{\em WhichOne}]If you have multiple TimerManagers this will choose which one to return. \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\paragraph[{GetWindowName}]{\setlength{\rightskip}{0pt plus 5cm}std::string phys::World::GetWindowName (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hfill}
...
Definition at line 384 of file world.cpp.
...
This also commits any outstanding log messages that are waiting in the \hyperlink{classphys_1_1World_a6d8b325a077afc924afb70c259ec0299}{World::LogStream}, and any outstanding Log messages from any subsystem. Currently the Graphics subsystem (Ogre3d) and the sound subsystem (cAudio) are the Only ones to produce meaningul log messages. 
...
\begin{DoxyParams}{Parameters}
\item[{\em Err}]A \hyperlink{classphys_1_1Exception}{phys::Exception} to be logged and thrown \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em message}]The string to log \end{DoxyParams}
...
\paragraph[{SetWindowName}]{\setlength{\rightskip}{0pt plus 5cm}void phys::World::SetWindowName (
\begin{DoxyParamCaption}
...
\begin{Desc}
\item[\hyperlink{todo__todo000030}{Todo}]TODO Change the name of an application once it is running \end{Desc}
...
Definition at line 541 of file world.cpp.
...
The contents of this will be commited to the log once per frame, just before rendering, or whenever \hyperlink{classphys_1_1World_a4ab573bc3b060d6b3f58483bab04fca2}{World::Log} is called. Because the entry of this data into the actual log file(or whatever destination) is delayed, do not use this for data that is likely to be required to debug something the frame something crashes. However, for other kinds of debugging data and creating in game logs and gameworld recreations. 

Definition at line 290 of file world.h.

\hypertarget{classphys_1_1World_a78f9e764aa85ac44d6f7fa7158377757}{
\index{phys::World@{phys::World}!TheRealWorld@{TheRealWorld}}
\index{TheRealWorld@{TheRealWorld}!phys::World@{phys::World}}
\paragraph[{TheRealWorld}]{\setlength{\rightskip}{0pt plus 5cm}{\bf World} $\ast$ {\bf phys::World::TheRealWorld} = 0\hspace{0.3cm}{\ttfamily  \mbox{[}static, protected\mbox{]}}}\hfill}
