...
This simply performs the same work as the descriptive constructor with some sane, but small, limits. It will give you a world which expands for 100 units from the Origin, and only allows 10 Adows. \begin{DoxyWarning}{Warning}
Do not make a new world if one already exists. This can only cause problems 
\end{DoxyWarning}
