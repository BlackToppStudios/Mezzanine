...
\end{DoxyWarning}
\begin{DoxyReturn}{Returns}
This returns a list$<$EventBase$\ast$$>$ which is this a subset of this classes event pointer list. Use this carefully, it can cause errors if used improperly.
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000007}{Todo}]Make version of this function for each type \end{Desc}
...
Definition at line 348 of file eventmanager.cpp.
