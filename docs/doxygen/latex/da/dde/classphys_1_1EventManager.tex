...
const list$<$ \hyperlink{classphys_1_1EventBase}{EventBase} $\ast$ $>$ $\ast$ \hyperlink{classphys_1_1EventManager_a96614684d2dcba5702b70dfe0d2a8c76}{GetAllEvents} () const 
...
list$<$ \hyperlink{classphys_1_1EventRenderTime}{EventRenderTime} $\ast$ $>$ $\ast$ \hyperlink{classphys_1_1EventManager_ae52d41b9cc8c818ad4af15e8d4f90d7a}{GetAllRenderTimeEvents} ()
...
list$<$ \hyperlink{classphys_1_1EventUserInput}{EventUserInput} $\ast$ $>$ $\ast$ \hyperlink{classphys_1_1EventManager_aff8eb19d37e98b459443d8417c8d4de6}{GetAllUserInputEvents} ()
...
list$<$ \hyperlink{classphys_1_1EventQuit}{EventQuit} $\ast$ $>$ $\ast$ \hyperlink{classphys_1_1EventManager_af547d813d112827a1662d22ab072da84}{GetAllQuitEvents} ()
...
\begin{DoxyCompactList}\small\item\em Returns a pointer to the Next kind event of the Specified type, and removes it from the Que. \item\end{DoxyCompactList}\item 
list$<$ \hyperlink{classphys_1_1EventBase}{EventBase} $\ast$ $>$ $\ast$ \hyperlink{classphys_1_1EventManager_a701bca02423436360c4e51b6e580cb2e}{GetAllSpecificEvents} (\hyperlink{classphys_1_1EventBase_a5e6a8564e127f654123f0bf6a2751923}{EventBase::EventType} SpecificType)
...
\hypertarget{classphys_1_1EventManager_a96614684d2dcba5702b70dfe0d2a8c76}{
...
\subsubsection[{GetAllEvents}]{\setlength{\rightskip}{0pt plus 5cm}const list$<$ {\bf EventBase} $\ast$ $>$ $\ast$ phys::EventManager::GetAllEvents () const}}
\label{da/dde/classphys_1_1EventManager_a96614684d2dcba5702b70dfe0d2a8c76}
...
\hypertarget{classphys_1_1EventManager_af547d813d112827a1662d22ab072da84}{
...
\subsubsection[{GetAllQuitEvents}]{\setlength{\rightskip}{0pt plus 5cm}list$<$ {\bf EventQuit} $\ast$ $>$ $\ast$ phys::EventManager::GetAllQuitEvents ()}}
\label{da/dde/classphys_1_1EventManager_af547d813d112827a1662d22ab072da84}
...
\end{DoxyWarning}
\begin{DoxyReturn}{Returns}
This returns a list$<$EventQuit$\ast$$>$ pointer which is this a subset of this classes event pointer list. Use this carefully, it can cause errors if used improperly. Additionally this list pointer must be deleted, but not the events in it. 
\end{DoxyReturn}


Definition at line 346 of file eventmanager.cpp.

\hypertarget{classphys_1_1EventManager_ae52d41b9cc8c818ad4af15e8d4f90d7a}{
...
\subsubsection[{GetAllRenderTimeEvents}]{\setlength{\rightskip}{0pt plus 5cm}list$<$ {\bf EventRenderTime} $\ast$ $>$ $\ast$ phys::EventManager::GetAllRenderTimeEvents ()}}
\label{da/dde/classphys_1_1EventManager_ae52d41b9cc8c818ad4af15e8d4f90d7a}
...
\hypertarget{classphys_1_1EventManager_a701bca02423436360c4e51b6e580cb2e}{
...
\subsubsection[{GetAllSpecificEvents}]{\setlength{\rightskip}{0pt plus 5cm}list$<$ {\bf EventBase} $\ast$ $>$ $\ast$ phys::EventManager::GetAllSpecificEvents ({\bf EventBase::EventType} {\em SpecificType})}}
\label{da/dde/classphys_1_1EventManager_a701bca02423436360c4e51b6e580cb2e}
...
\end{DoxyWarning}
\begin{DoxyReturn}{Returns}
This returns a list$<$EventBase$\ast$$>$ pointer which is this a subset of this classes event pointer list. Use this carefully, it can cause errors if used improperly. Additionally this list pointer must be deleted, but not the events in it. 
\end{DoxyReturn}


Definition at line 238 of file eventmanager.cpp.

\hypertarget{classphys_1_1EventManager_aff8eb19d37e98b459443d8417c8d4de6}{
...
\subsubsection[{GetAllUserInputEvents}]{\setlength{\rightskip}{0pt plus 5cm}list$<$ {\bf EventUserInput} $\ast$ $>$ $\ast$ phys::EventManager::GetAllUserInputEvents ()}}
\label{da/dde/classphys_1_1EventManager_aff8eb19d37e98b459443d8417c8d4de6}


This returns a complete list of all the User Input events. 

This finds all the \hyperlink{classphys_1_1EventUserInput}{EventUserInput} Events then creates a new list and returns that. This runs in linear time relative to the amounts of events. \begin{DoxyReturn}{Returns}
This returns a list$<$EventUserInput$\ast$$>$ pointer which is this a subset of this classes event pointer list. Use this carefully, it can cause errors if used improperly. Additionally this list pointer must be deleted, but not the events in it. 
\end{DoxyReturn}
...
Definition at line 459 of file eventmanager.cpp.
...
Definition at line 227 of file eventmanager.cpp.
