...
\subsubsection[{GetJoystickAxis}]{\setlength{\rightskip}{0pt plus 5cm}int phys::InputQueryTool::GetJoystickAxis (
\begin{DoxyParamCaption}
...
\subsubsection[{GetMouseWheelState}]{\setlength{\rightskip}{0pt plus 5cm}{\bf MetaCode::DirectionalMotionState} phys::InputQueryTool::GetMouseWheelState (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{IsJoystickButtonPushed}]{\setlength{\rightskip}{0pt plus 5cm}bool phys::InputQueryTool::IsJoystickButtonPushed (
\begin{DoxyParamCaption}
