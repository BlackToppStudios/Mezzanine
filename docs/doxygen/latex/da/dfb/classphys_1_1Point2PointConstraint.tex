...
\subsubsection[{Point2PointConstraint}]{\setlength{\rightskip}{0pt plus 5cm}phys::Point2PointConstraint::Point2PointConstraint (
\begin{DoxyParamCaption}
\item[{btPoint2PointConstraint $\ast$}]{ Constraint}
...
\subsubsection[{GetParam}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Real} phys::Point2PointConstraint::GetParam (
\begin{DoxyParamCaption}
\item[{int}]{ num, }
...
\subsubsection[{SetParam}]{\setlength{\rightskip}{0pt plus 5cm}void phys::Point2PointConstraint::SetParam (
\begin{DoxyParamCaption}
\item[{int}]{ num, }
\item[{{\bf Real}}]{ value, }
\item[{int}]{ axis = {\ttfamily -\/1}}
