...
void \hyperlink{classphys_1_1LineGroup_a550582bde23059645b5966a384734131}{addPoint} (const \hyperlink{classPhysVector3}{PhysVector3} \&p)
...
const \hyperlink{classPhysVector3}{PhysVector3} \hyperlink{classphys_1_1LineGroup_a16d15a03eab7029344fa73c1dfd7ca43}{getPoint} (\hyperlink{namespacephys_a460f6bc24c8dd347b05e0366ae34f34a}{Whole} index) const 
...
void \hyperlink{classphys_1_1LineGroup_a180c18bd979019c39a44c9c20b0e1f13}{updatePoint} (\hyperlink{namespacephys_a460f6bc24c8dd347b05e0366ae34f34a}{Whole} index, const \hyperlink{classPhysVector3}{PhysVector3} \&value)
\begin{DoxyCompactList}\small\item\em This changes a specific point. \item\end{DoxyCompactList}\item 
void \hyperlink{classphys_1_1LineGroup_aed46446e634948f8c73a5b26406cb5af}{drawLine} (const \hyperlink{classPhysVector3}{PhysVector3} \&start, const \hyperlink{classPhysVector3}{PhysVector3} \&end)
...
\begin{Desc}
\item[\hyperlink{todo__todo000009}{Todo}]TODO: This class really should support rotation, the underlying implementation does. \end{Desc}
...
Definition at line 302 of file linegroup.cpp.
...
Definition at line 308 of file linegroup.cpp.
...
\subsubsection[{addPoint}]{\setlength{\rightskip}{0pt plus 5cm}void phys::LineGroup::addPoint (const {\bf PhysVector3} \& {\em p})}}
...
Definition at line 313 of file linegroup.cpp.
...
\subsubsection[{drawLine}]{\setlength{\rightskip}{0pt plus 5cm}void phys::LineGroup::drawLine (const {\bf PhysVector3} \& {\em start}, \/  const {\bf PhysVector3} \& {\em end})}}
...
\item[\hyperlink{todo__todo000010}{Todo}]TODO: In the future we will add a break in the line segment chain when this is called. \end{Desc}

\begin{DoxyParams}{Parameters}
\item[{\em start}]The first point to be added \item[{\em end}]The first point to be added \end{DoxyParams}


Definition at line 334 of file linegroup.cpp.
...
\item[\hyperlink{todo__todo000011}{Todo}]TODO: PrepareForRendering should be rolled into drawLines, but this cannot happen until the physics debug rendererin gets more attention. \end{Desc}


Definition at line 341 of file linegroup.cpp.
...
Definition at line 346 of file linegroup.cpp.
...
Definition at line 324 of file linegroup.cpp.

\hypertarget{classphys_1_1LineGroup_a16d15a03eab7029344fa73c1dfd7ca43}{
\index{phys::LineGroup@{phys::LineGroup}!getPoint@{getPoint}}
\index{getPoint@{getPoint}!phys::LineGroup@{phys::LineGroup}}
\subsubsection[{getPoint}]{\setlength{\rightskip}{0pt plus 5cm}const {\bf PhysVector3} phys::LineGroup::getPoint ({\bf Whole} {\em index}) const}}
\label{db/ddb/classphys_1_1LineGroup_a16d15a03eab7029344fa73c1dfd7ca43}
...
Definition at line 318 of file linegroup.cpp.
...
Definition at line 351 of file linegroup.cpp.

\hypertarget{classphys_1_1LineGroup_a180c18bd979019c39a44c9c20b0e1f13}{
\index{phys::LineGroup@{phys::LineGroup}!updatePoint@{updatePoint}}
\index{updatePoint@{updatePoint}!phys::LineGroup@{phys::LineGroup}}
\subsubsection[{updatePoint}]{\setlength{\rightskip}{0pt plus 5cm}void phys::LineGroup::updatePoint ({\bf Whole} {\em index}, \/  const {\bf PhysVector3} \& {\em value})}}
\label{db/ddb/classphys_1_1LineGroup_a180c18bd979019c39a44c9c20b0e1f13}
...
Definition at line 329 of file linegroup.cpp.
