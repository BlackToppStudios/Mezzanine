...
\begin{Desc}
\item[\hyperlink{todo__todo000013}{Todo}]TODO: This class really should support rotation, the underlying implementation does. \end{Desc}
...
\item[\hyperlink{todo__todo000014}{Todo}]TODO: In the future we will add a break in the line segment chain when this is called. \end{Desc}
...
\item[\hyperlink{todo__todo000015}{Todo}]TODO: PrepareForRendering should be rolled into drawLines, but this cannot happen until the physics debug rendererin gets more attention. \end{Desc}
