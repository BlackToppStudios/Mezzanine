...
\item[\hyperlink{todo__todo000017}{Todo}]TODO: In the future we will add a break in the line segment chain when this is called. \end{Desc}
...
\item[\hyperlink{todo__todo000018}{Todo}]TODO: PrepareForRendering should be rolled into drawLines, but this cannot happen until the physics debug rendererin gets more attention. \end{Desc}
