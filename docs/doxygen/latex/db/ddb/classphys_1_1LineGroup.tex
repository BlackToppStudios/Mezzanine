...
\subsubsection[{LineGroup}]{\setlength{\rightskip}{0pt plus 5cm}phys::LineGroup::LineGroup (
...
\begin{Desc}
\item[\hyperlink{todo__todo000018}{Todo}]TODO: This class really should support rotation, the underlying implementation does. \end{Desc}
...
\subsubsection[{$\sim$LineGroup}]{\setlength{\rightskip}{0pt plus 5cm}phys::LineGroup::$\sim$LineGroup (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{addPoint}]{\setlength{\rightskip}{0pt plus 5cm}void phys::LineGroup::addPoint (
\begin{DoxyParamCaption}
...
\subsubsection[{drawLine}]{\setlength{\rightskip}{0pt plus 5cm}void phys::LineGroup::drawLine (
\begin{DoxyParamCaption}
...
\item[\hyperlink{todo__todo000019}{Todo}]TODO: In the future we will add a break in the line segment chain when this is called. \end{Desc}
...
\subsubsection[{drawLines}]{\setlength{\rightskip}{0pt plus 5cm}void phys::LineGroup::drawLines (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
)}}
...
\item[\hyperlink{todo__todo000020}{Todo}]TODO: PrepareForRendering should be rolled into drawLines, but this cannot happen until the physics debug rendererin gets more attention. \end{Desc}
...
\subsubsection[{getBoundingRadius}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Real} phys::LineGroup::getBoundingRadius (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
) const}}
...
\subsubsection[{getNumPoints}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Whole} phys::LineGroup::getNumPoints (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
) const}}
...
\subsubsection[{getPoint}]{\setlength{\rightskip}{0pt plus 5cm}const {\bf Vector3} phys::LineGroup::getPoint (
\begin{DoxyParamCaption}
\item[{{\bf Whole}}]{ index}
\end{DoxyParamCaption}
) const}}
...
\subsubsection[{updatePoint}]{\setlength{\rightskip}{0pt plus 5cm}void phys::LineGroup::updatePoint (
\begin{DoxyParamCaption}
\item[{{\bf Whole}}]{ index, }
