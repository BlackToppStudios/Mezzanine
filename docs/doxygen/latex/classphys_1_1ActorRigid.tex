...
\label{classphys_1_1ActorRigid_adaed962ee8ed788612e541fb00867c78}
...
\begin{DoxyParams}{Parameters}
{\em x} & Allow or Disallow use of the X axis for movement. \\
\hline
{\em y} & Allow or Disallow use of the Y axis for movement. \\
\hline
{\em z} & Allow or Disallow use of the Z axis for movement. \\
\hline
\end{DoxyParams}
