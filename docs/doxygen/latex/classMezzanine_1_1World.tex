...
\hypertarget{classMezzanine_1_1World_a98370ba288303e706826cd80401baed9}{
\index{Mezzanine::World@{Mezzanine::World}!GetWorldPointerValidity@{GetWorldPointerValidity}}
\index{GetWorldPointerValidity@{GetWorldPointerValidity}!Mezzanine::World@{Mezzanine::World}}
\paragraph[{GetWorldPointerValidity}]{\setlength{\rightskip}{0pt plus 5cm}bool Mezzanine::World::GetWorldPointerValidity (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}\hfill}
\label{classMezzanine_1_1World_a98370ba288303e706826cd80401baed9}


Is the world pointer valid. 

This exists to allow for future checks beyond just compare teh pointer to 0; \begin{DoxyReturn}{Returns}
true if the world pointer is valid. 
\end{DoxyReturn}
