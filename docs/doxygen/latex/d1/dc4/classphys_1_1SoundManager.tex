...
\hyperlink{structThis}{This} is simply a place for storing all the \hyperlink{classphys_1_1Sound}{Sound} utilities and functions.  
...
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} gets the logs that the audio subystem creates. \item\end{DoxyCompactList}\item 
void \hyperlink{classphys_1_1SoundManager_acc3551bcda7b1c681d83d81cc25747ae}{ClearLogs} ()
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} empties logs that the audio subystem creates. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
...
\hyperlink{structThis}{This} is simply a place for storing all the \hyperlink{classphys_1_1Sound}{Sound} utilities and functions. \hyperlink{structThis}{This} is a place for loading, storing, and running sound files as necessary in a given game. 
...
\hyperlink{structThis}{This} is the class constructor. It gives you the option to start up the manager with default values if you choose. If not then you'll need to setup and initialize the manager yourself after it is constructed. 
...
\hyperlink{structThis}{This} function will add a sound instance to a created sound set. 
\begin{DoxyParams}{Parameters}
...
\hyperlink{structThis}{This} empties logs that the audio subystem creates. 

Internally the Physgame engine currently uses cAudio to process 3d sound. It has it's own logging system that we have customized to work with our logger. \hyperlink{structThis}{This} clears that data allow us to work with it as we need 
...
\subsubsection[{CreateSound}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Sound} $\ast$ phys::SoundManager::CreateSound ({\bf String} \& {\em SoundName}, \/  {\bf String} \& {\em FilePath}, \/  bool {\em Stream})}}
...
\hyperlink{structThis}{This} function will create a \hyperlink{classphys_1_1Sound}{Sound} from a file and returns a pointer to that \hyperlink{classphys_1_1Sound}{Sound}. You can also specify if you want the sound to be streamed from the disk so that it doesn't have to load the entire song from disk first. 
\begin{DoxyParams}{Parameters}
...
\hyperlink{structThis}{This} function allows you to create a sound instance from a sound that is already loaded into memory. 
\begin{DoxyParams}{Parameters}
...
\hyperlink{structThis}{This} function will create a sound set vector you can use to store similiar sound instances. 
\begin{DoxyParams}{Parameters}
...
\hyperlink{structThis}{This} function will delete every \hyperlink{classphys_1_1Sound}{Sound} that is stored in the manager. 
...
\hyperlink{structThis}{This} function will return the total number of available devices, including the default. \begin{DoxyReturn}{Returns}
...
\hyperlink{structThis}{This} function will retrieve the name of a device by it's index on the sound managers device list. 
\begin{DoxyParams}{Parameters}
...
\hyperlink{structThis}{This} function will return the name of the system default device. \begin{DoxyReturn}{Returns}
...
\hyperlink{structThis}{This} function will return the listener for this manager which can be used to help create 3D sound. \begin{DoxyReturn}{Returns}
...
\hyperlink{structThis}{This} gets the logs that the audio subystem creates. 
...
\hyperlink{structThis}{This} gets the log of what actions the audio system has performed 
\end{DoxyReturn}
...
\hyperlink{structThis}{This} function will find and return the sound with the speicified name. \begin{DoxyReturn}{Returns}
...
\hyperlink{structThis}{This} function will find the specified sound set and return a pointer to it. 
\begin{DoxyParams}{Parameters}
...
\subsubsection[{InitializeManager}]{\setlength{\rightskip}{0pt plus 5cm}void phys::SoundManager::InitializeManager ({\bf String} \& {\em DeviceName}, \/  int {\em OutputFrequency} = {\ttfamily -\/1}, \/  int {\em EAXEffectSlots} = {\ttfamily 4})}}
\label{d1/dc4/classphys_1_1SoundManager_aa0fc07170611851f3fa888c8e28d99df}


Initializes the Manager. 

\hyperlink{structThis}{This} function will initialize the manager using the device and parameters provided. You need to call this function if you passed false into the sound manager constructor before you can use the manager. 
\begin{DoxyParams}{Parameters}
