...
Definition at line 74 of file actorcontainerbase.h.
...
\par
 This will not add the Actor to any specific location in the ordering of the container. \begin{DoxyWarning}{Warning}
This will cause issues if used with a container attached to a valid \hyperlink{classphys_1_1World}{phys::World}. Use \hyperlink{classphys_1_1World_a0fec41ef68b7bb1443aab927f8277a81}{World::AddActor} instead. 
\end{DoxyWarning}
...
This will cause issues if used with a container attached to a valid \hyperlink{classphys_1_1World}{phys::World}. Use \hyperlink{classphys_1_1World_ab00f84983afcc7f6ef1e5a84367d994d}{World::RemoveActor} instead. 
\end{DoxyWarning}
