...
\paragraph[{AddActor}]{\setlength{\rightskip}{0pt plus 5cm}void phys::ActorContainerBase::AddActor (
\begin{DoxyParamCaption}
...
\paragraph[{DoMainLoopItems}]{\setlength{\rightskip}{0pt plus 5cm}virtual void phys::ActorContainerBase::DoMainLoopItems (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}pure virtual\mbox{]}}}\hfill}
...
\paragraph[{GetCollisionObject}]{\setlength{\rightskip}{0pt plus 5cm}btCollisionObject $\ast$ phys::ActorContainerBase::GetCollisionObject (
\begin{DoxyParamCaption}
...
\paragraph[{GetNode}]{\setlength{\rightskip}{0pt plus 5cm}Ogre::SceneNode $\ast$ phys::ActorContainerBase::GetNode (
\begin{DoxyParamCaption}
\item[{{\bf ActorBase} $\ast$}]{ actor}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}\hfill}
...
\paragraph[{GetType}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ManagerBase::ManagerTypeName} phys::ActorContainerBase::GetType (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\paragraph[{Initialize}]{\setlength{\rightskip}{0pt plus 5cm}virtual void phys::ActorContainerBase::Initialize (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}pure virtual\mbox{]}}}\hfill}
...
\paragraph[{RemoveActor}]{\setlength{\rightskip}{0pt plus 5cm}void phys::ActorContainerBase::RemoveActor (
\begin{DoxyParamCaption}
