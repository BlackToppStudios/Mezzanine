...
Definition at line 72 of file rayquerytool.cpp.
...
{\em ObjectFlags} & A whole comprising all the valid objects to be checked in the scene. See WorldAndSceneObjectType in \hyperlink{enumerations_8h_source}{enumerations.h} for a listing of objects to use as flags. \\
\hline
...
Definition at line 216 of file rayquerytool.cpp.
...
\begin{Desc}
\item[\hyperlink{todo__todo000025}{Todo}]TODO: The function WorldQueryTool::GetFirstActorOnRayByAABB does not return an valid offset. This needs to be calculated somehow. \end{Desc}
\begin{Desc}
\item[\hyperlink{todo__todo000026}{Todo}]TODO: The function WorldQueryTool::GetFirstActorOnRayByAABB has not been tested and needs to be tested \end{Desc}
\begin{Desc}
\item[\hyperlink{todo__todo000027}{Todo}]TODO: The function WorldQueryTool::GetFirstActorOnRayByAABB does not take other obstructions into account \end{Desc}




Definition at line 180 of file rayquerytool.cpp.
...
Definition at line 82 of file rayquerytool.cpp.
...
Definition at line 334 of file rayquerytool.cpp.
...
Definition at line 234 of file rayquerytool.cpp.
