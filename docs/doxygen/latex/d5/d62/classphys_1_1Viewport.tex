...
\label{d5/d62/classphys_1_1Viewport}\index{phys::Viewport@{phys::Viewport}}
}
...
\subsubsection[{Viewport}]{\setlength{\rightskip}{0pt plus 5cm}phys::Viewport::Viewport (
...
\label{d5/d62/classphys_1_1Viewport_a83634ee2144fadd80fec3028885b92f2}
...
\item[{\em ViewportCamera}]The camera that is to be attached to this veiwport. \item[{\em ZOrder}]The render order of this viewport relative to other viewports in the game window. \item[{\em ParentWindow}]The game window this viewport belongs to. \end{DoxyParams}
...
\subsubsection[{GetActualHeight}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Whole} phys::Viewport::GetActualHeight (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{d5/d62/classphys_1_1Viewport_a1eee22594548a38910dee8e838e6449d}
...
\subsubsection[{GetActualLeft}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Whole} phys::Viewport::GetActualLeft (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{d5/d62/classphys_1_1Viewport_ad0390466fc2980e8469ddcbed66900ca}
...
\subsubsection[{GetActualTop}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Whole} phys::Viewport::GetActualTop (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{d5/d62/classphys_1_1Viewport_a1eff4fac830986548cb94123b6b31898}
...
\subsubsection[{GetActualWidth}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Whole} phys::Viewport::GetActualWidth (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{d5/d62/classphys_1_1Viewport_a301262e5da6926296241f0e2cc2de7d2}
...
\subsubsection[{GetHeight}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Real} phys::Viewport::GetHeight (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{d5/d62/classphys_1_1Viewport_ae1a6473f3ccdac16535f985453caf691}
...
\subsubsection[{GetLeft}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Real} phys::Viewport::GetLeft (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{d5/d62/classphys_1_1Viewport_a9a5667cbbb1127a89e4702219fe44c7a}
...
\subsubsection[{GetOgreViewport}]{\setlength{\rightskip}{0pt plus 5cm}Ogre::Viewport $\ast$ phys::Viewport::GetOgreViewport (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}}
\label{d5/d62/classphys_1_1Viewport_a005b39a37464c4f4a365c2bdb08ffb04}
...
\subsubsection[{GetParentWindow}]{\setlength{\rightskip}{0pt plus 5cm}{\bf GameWindow} $\ast$ phys::Viewport::GetParentWindow (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{d5/d62/classphys_1_1Viewport_ac350d4c2e790edd488b212ccb6b20991}
...
\subsubsection[{GetTop}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Real} phys::Viewport::GetTop (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{d5/d62/classphys_1_1Viewport_af5d0413ab59dcd7bd428d73762a239e4}
...
\subsubsection[{GetViewportCamera}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Camera} $\ast$ phys::Viewport::GetViewportCamera (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{d5/d62/classphys_1_1Viewport_a755f7ede5f6552ef8b64d75f745b7957}
...
\subsubsection[{GetWidth}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Real} phys::Viewport::GetWidth (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{d5/d62/classphys_1_1Viewport_af6df304a6b33f34134b29a61deb98e55}
...
\subsubsection[{SetDimensions}]{\setlength{\rightskip}{0pt plus 5cm}void phys::Viewport::SetDimensions (
\begin{DoxyParamCaption}
...
\label{d5/d62/classphys_1_1Viewport_a49269f1ada31f280adc8d832c9536514}
...
\begin{DoxyParams}{Parameters}
\item[{\em Left}]A relative value(range: 0-\/1) representing the leftmost position of the viewport. \item[{\em Top}]A relative value(range: 0-\/1) representing the topmost position of the viewport. \item[{\em Width}]A relative value(range: 0-\/1) representing the width of the viewport. \item[{\em Height}]A relative value(range: 0-\/1) representing the height of the viewport. \end{DoxyParams}
...
\label{d5/d62/classphys_1_1Viewport_a0d0c47add1187921fd40a8c8c363bc30}
...
\begin{DoxyParams}{Parameters}
\item[{\em Position}]\hyperlink{classphys_1_1Vector2}{Vector2} of relative values(range: 0-\/1) representing the top left corner of the viewport. Values are relative to the game window this viewport belongs to. \item[{\em Size}]\hyperlink{classphys_1_1Vector2}{Vector2} of relative values(range: 0-\/1) representing the width and height of the viewport. Values are relative to the game window this viewport belongs to. \end{DoxyParams}
