...
\subsubsection[{CreateScreen}]{\setlength{\rightskip}{0pt plus 5cm}{\bf UIScreen} $\ast$ phys::UIManager::CreateScreen (const {\bf String} \& {\em Screen}, \/  const {\bf String} \& {\em Atlas}, \/  const {\bf String} \& {\em Viewport} = {\ttfamily \char`\"{}DefaultViewport\char`\"{}})}}
...
\subsubsection[{DestroyScreen}]{\setlength{\rightskip}{0pt plus 5cm}void phys::UIManager::DestroyScreen ({\bf UIScreen} $\ast$ {\em Screen})}}
...
\subsubsection[{GetLayer}]{\setlength{\rightskip}{0pt plus 5cm}{\bf UILayer} $\ast$ phys::UIManager::GetLayer ({\bf String} \& {\em Name})}}
...
\subsubsection[{GetScreen}]{\setlength{\rightskip}{0pt plus 5cm}{\bf UIScreen} $\ast$ phys::UIManager::GetScreen ({\bf Whole} {\em Index})}}
...
\index{phys::UIManager@{phys::UIManager}!GetScreen@{GetScreen}}
\index{GetScreen@{GetScreen}!phys::UIManager@{phys::UIManager}}
\subsubsection[{GetScreen}]{\setlength{\rightskip}{0pt plus 5cm}{\bf UIScreen} $\ast$ phys::UIManager::GetScreen (const {\bf String} \& {\em Name})}}
...
\subsubsection[{LoadGorilla}]{\setlength{\rightskip}{0pt plus 5cm}void phys::UIManager::LoadGorilla (const {\bf String} \& {\em Name})}}
