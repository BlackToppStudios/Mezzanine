...
\hyperlink{structThis}{This} is used to represent a point in space, or a vector through space.  
...
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} is used to calculate the crossproduct of this and another vector. \item\end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} is used to calculate the dotproduct of this and another vector. \item\end{DoxyCompactList}\item 
void \hyperlink{classphys_1_1Vector3_ae39fe0545df88148bcd668b3bd2a4388}{Normalize} ()
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} will change this point into it's own normal relative to the origin. \item\end{DoxyCompactList}\item 
\hyperlink{classphys_1_1Vector3}{Vector3} \hyperlink{classphys_1_1Vector3_a81e11f45378758391c97ec55b519951c}{GetNormal} () const 
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} returns the normal for this relative to the origin. \item\end{DoxyCompactList}\item 
void \hyperlink{classphys_1_1Vector3_a30af9c8ae51596fa00fa7f350f9668f5}{Inverse} ()
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} will inverse the reals in the vector. \item\end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} return the distance between this point and another. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
...
\hyperlink{structThis}{This} is used to represent a point in space, or a vector through space. \hyperlink{structThis}{This} contains an X, Y and a Z value used to represent coordinates. \hyperlink{structThis}{This} also has a number of facilities to make converting from Physics subsystem vectors or graphics subsystems as easy as possible 
...
\index{phys::Vector3@{phys::Vector3}!Vector3@{Vector3}}
\index{Vector3@{Vector3}!phys::Vector3@{phys::Vector3}}
\subsubsection[{Vector3}]{\setlength{\rightskip}{0pt plus 5cm}phys::Vector3::Vector3 (cAudio::cVector3 {\em Vec})}}
...
\subsubsection[{CrossProduct}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Vector3} phys::Vector3::CrossProduct (const {\bf Vector3} \& {\em rkVector}) const}}
\label{d5/d6a/classphys_1_1Vector3_ae98b11238914cd77a729053798ebf339}


\hyperlink{structThis}{This} is used to calculate the crossproduct of this and another vector. 

\hyperlink{structThis}{This} creates a third vector, which should be on a line perpendicular to lines that contain the origin and the other vectors \par
\par
...
\hyperlink{structThis}{This} is the crossproduct of this vector and rkVector 
\end{DoxyReturn}
...
\hyperlink{structThis}{This} return the distance between this point and another. 

\hyperlink{structThis}{This} uses a 3d extension of pythagoras thereom to calculate the distance between \hyperlink{structThis}{This} \hyperlink{classphys_1_1Vector3}{Vector3} and another. 
\begin{DoxyParams}{Parameters}
\item[{\em Vec2}]this is the other point to measure against \end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{structThis}{This} returns a Real number which is the distance. 
\end{DoxyReturn}
...
\subsubsection[{dotProduct}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Real} phys::Vector3::dotProduct (const {\bf Vector3} \& {\em vec}) const}}
\label{d5/d6a/classphys_1_1Vector3_ac30ef9729b1a4e6001f5f5219a88176d}


\hyperlink{structThis}{This} is used to calculate the dotproduct of this and another vector. 

\hyperlink{structThis}{This} calculates the sum of the products of X, Y and Z. \par
\par
 Thanks to the guys at Ogre3d for the well written version of this function that we based this on. 
\begin{DoxyParams}{Parameters}
\item[{\em vec}]The vector to work with to create the cross product \end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{structThis}{This} is the dotproduct of this vector and vec 
\end{DoxyReturn}
...
\hyperlink{structThis}{This} function will copy the values stored in an existing Bullet vector3 and set the values of this class to be the same. 
\begin{DoxyParams}{Parameters}
\item[{\em temp}]The vector3 to be extracted. \end{DoxyParams}


Definition at line 337 of file vector3.cpp.
...
\subsubsection[{ExtractcAudioVector3}]{\setlength{\rightskip}{0pt plus 5cm}void phys::Vector3::ExtractcAudioVector3 (cAudio::cVector3 {\em temp})}}
\label{d5/d6a/classphys_1_1Vector3_aa12021e9cdc092c8628ced1c5910c04c}


Copies an existing cAudio vector3. 

\hyperlink{structThis}{This} function will copy the values stored in an existing cAudio vector3 and set the values of this class to be the same. 
\begin{DoxyParams}{Parameters}
\item[{\em temp}]The vector3 to be extracted. \end{DoxyParams}


Definition at line 369 of file vector3.cpp.
...
\hyperlink{structThis}{This} function will copy the values stored in an existing Ogre vector3 and set the values of this class to be the same. 
\begin{DoxyParams}{Parameters}
\item[{\em temp}]The vector3 to be extracted. \end{DoxyParams}


Definition at line 353 of file vector3.cpp.
...
\subsubsection[{GetcAudioVector3}]{\setlength{\rightskip}{0pt plus 5cm}cAudio::cVector3 phys::Vector3::GetcAudioVector3 () const}}
...
\subsubsection[{GetNormal}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Vector3} phys::Vector3::GetNormal () const}}
\label{d5/d6a/classphys_1_1Vector3_a81e11f45378758391c97ec55b519951c}


\hyperlink{structThis}{This} returns the normal for this relative to the origin. 

\hyperlink{structThis}{This} will return a vector that is 1 unit in away from the origin, if a line were starting and the origin it would pass through both the normal and the original point. \begin{DoxyReturn}{Returns}
At a vector3 that is the normal of this \hyperlink{classphys_1_1Vector3}{Vector3} or 0,0,0 if the current Vector is all 0s 
\end{DoxyReturn}


\begin{Desc}
\item[\hyperlink{todo__todo000022}{Todo}]discuss the merits throwing an error here. \end{Desc}
...
Definition at line 344 of file vector3.cpp.
...
\hyperlink{structThis}{This} will inverse the reals in the vector. 

\hyperlink{structThis}{This} function will inverse all the reals in the vector. 

Definition at line 318 of file vector3.cpp.
...
\hyperlink{structThis}{This} will change this point into it's own normal relative to the origin. 

\hyperlink{structThis}{This} will change this vector into one that is the same direction from the origin, but only one unit a away. 

\begin{Desc}
\item[\hyperlink{todo__todo000021}{Todo}]discuss the merits throwing an error here. \end{Desc}
...
\begin{DoxyParams}{Parameters}
\item[{\em Vec2}]\hyperlink{structThis}{This} is the Ogre::Vector3 to be multiplied \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em Vec2}]\hyperlink{structThis}{This} is the btVector3 to be multiplied \end{DoxyParams}


Definition at line 221 of file vector3.cpp.
...
\begin{DoxyParams}{Parameters}
\item[{\em Vec2}]\hyperlink{structThis}{This} is the other \hyperlink{classphys_1_1Vector3}{phys::Vector3} \end{DoxyParams}
...
\hyperlink{structThis}{This} Multiplies X, Y and Z by scalar \begin{DoxyReturn}{Returns}
\hyperlink{structThis}{This} returns a \hyperlink{classphys_1_1Vector3}{Vector3} that has been scaled 
\end{DoxyReturn}

\begin{DoxyParams}{Parameters}
\item[{\em scalar}]\hyperlink{structThis}{This} is the amount to scale the \hyperlink{classphys_1_1Vector3}{Vector3} by \end{DoxyParams}
...
\hyperlink{structThis}{This} Multiplies X, Y and Z by scalar and stores the changes in this \hyperlink{classphys_1_1Vector3}{Vector3}. 
\begin{DoxyParams}{Parameters}
\item[{\em scalar}]\hyperlink{structThis}{This} is the amount to scale the \hyperlink{classphys_1_1Vector3}{Vector3} by. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em Vec2}]\hyperlink{structThis}{This} is the Ogre::Vector3 to be added \end{DoxyParams}


Definition at line 242 of file vector3.cpp.
...
\begin{DoxyParams}{Parameters}
\item[{\em Vec2}]\hyperlink{structThis}{This} is the btVector3 to be added \end{DoxyParams}


Definition at line 203 of file vector3.cpp.
...
\begin{DoxyParams}{Parameters}
\item[{\em Vec2}]\hyperlink{structThis}{This} is the Ogre::Vector3 to be subtracted \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em Vec2}]\hyperlink{structThis}{This} is the btVector3 to be subtracted \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em Vec2}]\hyperlink{structThis}{This} is the Ogre::Vector3 to be divided \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em Vec2}]\hyperlink{structThis}{This} is the btVector3 to be divided \end{DoxyParams}
...
\hyperlink{structThis}{This} Diisionn X, Y and Z by scalar \begin{DoxyReturn}{Returns}
\hyperlink{structThis}{This} returns a \hyperlink{classphys_1_1Vector3}{Vector3} that has been scaled 
\end{DoxyReturn}
...
\hyperlink{structThis}{This} Division X, Y and Z by scalar and and stores the changes in this \hyperlink{classphys_1_1Vector3}{Vector3}. 
\begin{DoxyParams}{Parameters}
\item[{\em scalar}]\hyperlink{structThis}{This} is the amount to scale the \hyperlink{classphys_1_1Vector3}{Vector3} by \end{DoxyParams}
...
\hyperlink{structThis}{This} copies the x,y and z values from the bullet into this vector 
\begin{DoxyParams}{Parameters}
\item[{\em OVec3}]\hyperlink{structThis}{This} is a Ogre::Vector3 that will be copied. \end{DoxyParams}
...
\hyperlink{structThis}{This} copies the x,y and z values from the bullet into this vector 
\begin{DoxyParams}{Parameters}
\item[{\em bt3}]\hyperlink{structThis}{This} is a btVector3 that will be copied \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em Vec2}]\hyperlink{structThis}{This} is an Ogre::Vector3 that needs to be compared with this. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em Vec2}]\hyperlink{structThis}{This} is an btVector3 that needs to be compared with this. \end{DoxyParams}
