...
\index{phys::Vector3@{phys::Vector3}!operator=@{operator=}}
\index{operator=@{operator=}!phys::Vector3@{phys::Vector3}}
\subsubsection[{operator=}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Vector3} \& phys::Vector3::operator= (const Ogre::Vector3 \& {\em OVec3})}}
...
\index{phys::Vector3@{phys::Vector3}!operator=@{operator=}}
\index{operator=@{operator=}!phys::Vector3@{phys::Vector3}}
\subsubsection[{operator=}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Vector3} \& phys::Vector3::operator= (const btVector3 \& {\em bt3})}}
