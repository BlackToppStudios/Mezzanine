...
\subsubsection[{EventCollision}]{\setlength{\rightskip}{0pt plus 5cm}phys::EventCollision::EventCollision (
...
\subsubsection[{GetType}]{\setlength{\rightskip}{0pt plus 5cm}{\bf EventBase::EventType} phys::EventCollision::GetType (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
