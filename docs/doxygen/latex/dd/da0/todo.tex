...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1AreaEffect_afa5456c457c8fa61bd3ea5d83f3296a4}{phys::AreaEffect::CreateGraphicsBox}(String \&MaterialName) ]The HalfExtents returned here includes scaling, should account for that so weird scaling sync issues don't occur. 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1GraphicsManager_aeea7f2f26a3f9a53754ad34219f75e99}{phys::GraphicsManager::setFullscreen}(const bool \&Fullscreen) ]TODO: Need to attempt to switch to fullscreen here 
...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1GraphicsManager_afc98369b4c2664990c6b5a0370e5e74e}{phys::GraphicsManager::setRenderHeight}(const Whole \&Height) ]TODO: Need to attempt to update resolution here 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1GraphicsManager_ad61858461f05ddb9cadec77eea41abde}{phys::GraphicsManager::setRenderResolution}(const Whole \&Width, const Whole \&Height) ]TODO: Need to attempt to update resolution here 

Need to add a function that will sanitize a window size to account for decorations, and add it here. 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1GraphicsManager_a00215d086bc439c64906186f02a9bd76}{phys::GraphicsManager::setRenderWidth}(const Whole \&Width) ]TODO: Need to attempt to update resolution here 
\end{DoxyDescription}
...
\label{dd/da0/todo__todo000036}
\hypertarget{dd/da0/todo__todo000036}{}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1xml_1_1Node_a042f7cd4673abcc48625d784a73756a5}{phys::xml::Node::AppendChild}(NodeType Type=NodeElement) ]Not all nodes can be added to other nodes, we need to figure it out and put it here. 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1xml_1_1Node_a2880fe4ee0790304212510988c3e0142}{phys::xml::Node::AppendChild}(const char\_\-t $\ast$Name) ]Not all nodes can be added to other nodes, we need to figure it out and put it here. 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1xml_1_1Node_ab1f30456558a3331ccf5994485dae7ee}{phys::xml::Node::FirstElementByPath}(const char\_\-t $\ast$Path, char\_\-t delimiter= '/') const  ]Investigate this more deeply. 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1xml_1_1Node_a762994a2b67cb16364e67c7d86b3bbb4}{phys::xml::Node::InsertChildAfter}(NodeType Type, const \hyperlink{classNode}{Node} \&node) ]Not all nodes can be added to other nodes, we need to figure it out and put it here. 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1xml_1_1Node_a4c5ea2b2fd7fe9fb0bd3c1475629a650}{phys::xml::Node::InsertChildBefore}(NodeType Type, const \hyperlink{classNode}{Node} \&node) ]Not all nodes can be added to other nodes, we need to figure it out and put it here. 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1xml_1_1Node_ae936ff115dc220ec391747e6cafc761b}{phys::xml::Node::SetValue}(const char\_\-t $\ast$rhs) ]update this to make the error return code redundant and use an exception instead. 
