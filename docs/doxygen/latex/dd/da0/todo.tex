...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1Vector3_a30af9c8ae51596fa00fa7f350f9668f5}{phys::Vector3::Inverse}() ]fix division by zero in Vector3::Inverse() 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1WorldNode_a82710a08f767447266c1307b55a5636b}{phys::WorldNode::AttachElement}(Attachable $\ast$Element) ]refactor Worldnode to call methods on Attachable instead of reaching into classes. 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1WorldNode_ab5ce9ccc5dea9a450f3f72442ca10cf5}{phys::WorldNode::DetachElement}(Attachable $\ast$Element) ]refactor Worldnode::DetachElement to call methods on Attachable instead of reaching into classes. 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1xml_1_1Node_a643a7e8d8cbee41647e4e1121660b5d0}{phys::xml::Node::PrependChild}(const char\_\-t $\ast$Name) ]Not all nodes can be added to other nodes, we need to figure it out and put it here. 
\end{DoxyDescription}
