...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1EventManager_a01a5a131ac26679eee5dcf5dd514045c}{phys::EventManager::UpdateUserInputEvents}() ]This isn't pretty, should be replaced with a more elegant solution that'll work on keyboard events as well. 
\end{DoxyDescription}
