...
\begin{DoxyDescription}
\item[Namespace \hyperlink{namespacephys_1_1debug}{phys::debug} ]This whole debug namespace is a dirty hack. Items that cannot be made public, ie help classes, which could also conceivably be left out of release build. 
\end{DoxyDescription}
