...
\begin{DoxyDescription}
\item[Namespace \hyperlink{namespacephys_1_1debug}{phys::debug} ]This whole debug namespace is a dirty hack. It needs to be broken out into a 3d line class and some kind, but the Debug render can probably stay internal 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1debug_1_1InternalDebugDrawer_a8a35c3c80fddaaec8e21f737ed1b3938}{phys::debug::InternalDebugDrawer::drawLine}(const btVector3 \&from, const btVector3 \&to, const btVector3 \&color) ]fix 
\end{DoxyDescription}
