...
\hyperlink{classActorBase_a5a0e5dc193a2dca9d0f823dad7fdaa7a}{ActorBase} (String name, String file, String group, \hyperlink{classphys_1_1World}{World} $\ast$\hyperlink{classphys_1_1World}{World})
...
\begin{DoxyCompactItemize}
\item 
virtual void \hyperlink{classActorBase_a8c5401ae316ad2fbc1279016cef4c9f6}{AddObjectToWorld} (\hyperlink{classphys_1_1World}{World} $\ast$TargetWorld, btSoftRigidDynamicsWorld $\ast$\hyperlink{classphys_1_1World}{World})=0
...
\begin{DoxyCompactItemize}
\item 
\hypertarget{classActorBase_a8c75fa8ccf16922aded9f0fd696578ef}{
\hyperlink{classphys_1_1World}{World} $\ast$ {\bfseries GameWorld}}
\label{dd/d7b/classActorBase_a8c75fa8ccf16922aded9f0fd696578ef}
...
\begin{DoxyCompactItemize}
\item 
\hypertarget{classActorBase_a7b4bcdf992c21ae83363f25df05b1d25}{
class {\bfseries World}}
\label{dd/d7b/classActorBase_a7b4bcdf992c21ae83363f25df05b1d25}

\end{DoxyCompactItemize}


\subsection{Detailed Description}
This is the base class from which all the actors inherit. The actor classes store and manage all the relevant data regarding objects inside the World. They serve as a binder between the physics and graphics for objects and have functions that allow the manipulation of objects loaded into the World. Currently there are 4 actor classes: \hyperlink{classActorBase}{ActorBase}, ActorDynRigid, ActorDynSoft, and ActorSta. \par
...
\hypertarget{classActorBase_a5a0e5dc193a2dca9d0f823dad7fdaa7a}{
\index{ActorBase@{ActorBase}!ActorBase@{ActorBase}}
\index{ActorBase@{ActorBase}!ActorBase@{ActorBase}}
\subsubsection[{ActorBase}]{\setlength{\rightskip}{0pt plus 5cm}ActorBase::ActorBase (String {\em name}, \/  String {\em file}, \/  String {\em group}, \/  {\bf World} $\ast$ {\em World})}}
\label{dd/d7b/classActorBase_a5a0e5dc193a2dca9d0f823dad7fdaa7a}
...
\item[{\em Name}]The name of the actor. \item[{\em File}]The 3d mesh file that contains the 3d model the actor will use. \item[{\em Group}]The resource group where the 3d mesh and other related files can be found. \item[{\em World}]Pointer to the World this object will be added to. \end{DoxyParams}
...
\hypertarget{classActorBase_a8c5401ae316ad2fbc1279016cef4c9f6}{
\index{ActorBase@{ActorBase}!AddObjectToWorld@{AddObjectToWorld}}
\index{AddObjectToWorld@{AddObjectToWorld}!ActorBase@{ActorBase}}
\subsubsection[{AddObjectToWorld}]{\setlength{\rightskip}{0pt plus 5cm}virtual void ActorBase::AddObjectToWorld ({\bf World} $\ast$ {\em TargetWorld}, \/  btSoftRigidDynamicsWorld $\ast$ {\em World})\hspace{0.3cm}{\ttfamily  \mbox{[}protected, pure virtual\mbox{]}}}}
\label{dd/d7b/classActorBase_a8c5401ae316ad2fbc1279016cef4c9f6}
...
Implemented in \hyperlink{classActorRigid_a2dc29c81eae90d3344fda0a80f066448}{ActorRigid}, and \hyperlink{classActorSoft_a2c9b96e757040add73272ed392c3a464}{ActorSoft}.
...
Calling this function after adding it to the World will have no effect. \par
...
Calling this function prior to adding it to the World will have no effect. \par
