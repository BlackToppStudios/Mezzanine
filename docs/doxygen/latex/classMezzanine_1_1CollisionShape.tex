...
\begin{DoxyReturn}{Returns}
Returns a \hyperlink{classvector3}{vector3} representing the amount of scaling being applied to the shape. 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
{\em Scaling} & A \hyperlink{classvector3}{vector3} representing how much scaling should be applied on each of the shapes 3 axes. \\
\hline
\end{DoxyParams}
