...
\label{classphys_1_1SoundManager}\index{phys::SoundManager@{phys::SoundManager}}
}
...
Todo de/serialize sound set. This is simply a place for storing all the \hyperlink{classphys_1_1Sound}{Sound} utilities and functions.
...
\paragraph[{SoundManager}]{\setlength{\rightskip}{0pt plus 5cm}phys::SoundManager::SoundManager (
\begin{DoxyParamCaption}
\item[{bool}]{DefaultSettings = {\ttfamily true}}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_a42d41090652f8ef12d575d78881d6a05}
...
\paragraph[{$\sim$SoundManager}]{\setlength{\rightskip}{0pt plus 5cm}phys::SoundManager::$\sim$SoundManager (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_af557110e5f0eccc7be861f163e1670d0}
...
\paragraph[{AddSoundToSoundSet}]{\setlength{\rightskip}{0pt plus 5cm}void phys::SoundManager::AddSoundToSoundSet (
\begin{DoxyParamCaption}
\item[{{\bf String}}]{SoundSetName, }
\item[{{\bf Sound} $\ast$}]{SoundInst}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_a89c05a5628e187939ea30b0e4b149931}
...
Definition at line 172 of file soundmanager.cpp.
...
\paragraph[{ClearLogs}]{\setlength{\rightskip}{0pt plus 5cm}void phys::SoundManager::ClearLogs (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_acc3551bcda7b1c681d83d81cc25747ae}
...
Definition at line 211 of file soundmanager.cpp.
...
\paragraph[{CreateSound}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Sound} $\ast$ phys::SoundManager::CreateSound (
\begin{DoxyParamCaption}
\item[{{\bf ConstString} \&}]{SoundName, }
\item[{{\bf ConstString} \&}]{FilePath, }
\item[{bool}]{Stream}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_a4504934e7a6a75045f0a8d303b7be0b8}
...
\begin{DoxyParams}{Parameters}
{\em SoundName} & The name of the \hyperlink{classphys_1_1Sound}{Sound} instance. \\
\hline
{\em FilePath} & The path to the file AND the name of the file. \\
\hline
{\em Stream} & Whether or not to stream the audio from the disk. Otherwise it has be completely loaded into memory before it can be used. \\
\hline
\end{DoxyParams}
...
Definition at line 92 of file soundmanager.cpp.
...
\paragraph[{CreateSoundFromMemory}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Sound} $\ast$ phys::SoundManager::CreateSoundFromMemory (
\begin{DoxyParamCaption}
...
\label{classphys_1_1SoundManager_aa039c3d7a5ee961be0934a58fd3826fa}
...
\hline
{\em Data} & Pointer to the char array (buffer). \\
\hline
{\em Size} & Size of the char array (buffer). \\
\hline
{\em Extension} & The extension of the file used to load that sound (wav, ogg). \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Returns a pointer to the \hyperlink{classphys_1_1Sound}{Sound} Instance that was created. 
...
\paragraph[{CreateSoundSet}]{\setlength{\rightskip}{0pt plus 5cm}{\bf SoundSet} $\ast$ phys::SoundManager::CreateSoundSet (
\begin{DoxyParamCaption}
\item[{{\bf String}}]{SoundSetName}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_afccb11a6f6d9aa9768a185febb0af45a}
...
\paragraph[{DestroyAllSounds}]{\setlength{\rightskip}{0pt plus 5cm}void phys::SoundManager::DestroyAllSounds (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_a0f523240530abd5ab437c9eace78056a}
...
\paragraph[{DestroySound}]{\setlength{\rightskip}{0pt plus 5cm}void phys::SoundManager::DestroySound (
\begin{DoxyParamCaption}
\item[{{\bf Sound} $\ast$}]{SoundName}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_a6a996829cab647ccf1ca401361af7167}
...
\begin{DoxyParams}{Parameters}
{\em SoundName} & A pointer to the \hyperlink{classphys_1_1Sound}{Sound} you want deleted. \\
\hline
\end{DoxyParams}
...
\paragraph[{DoMainLoopItems}]{\setlength{\rightskip}{0pt plus 5cm}void phys::SoundManager::DoMainLoopItems (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}\hfill}
\label{classphys_1_1SoundManager_a577b228753ea19856b8476ab831e547e}
...
Definition at line 83 of file soundmanager.cpp.
...
\paragraph[{GetAvailableDeviceCount}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Whole} phys::SoundManager::GetAvailableDeviceCount (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_adb5717af71da8829600fd613a2ce615b}
...
Definition at line 192 of file soundmanager.cpp.
...
\paragraph[{GetAvailableDeviceNameByIndex}]{\setlength{\rightskip}{0pt plus 5cm}{\bf String} phys::SoundManager::GetAvailableDeviceNameByIndex (
\begin{DoxyParamCaption}
\item[{{\bf Whole}}]{Index}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_a842f7cba6b12585bca77f642ecb8be79}
...
Definition at line 178 of file soundmanager.cpp.
...
\paragraph[{GetDefaultDeviceName}]{\setlength{\rightskip}{0pt plus 5cm}{\bf String} phys::SoundManager::GetDefaultDeviceName (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_ac4814331683597034b26fac5c1c69bfa}
...
Definition at line 185 of file soundmanager.cpp.
...
\paragraph[{GetListener}]{\setlength{\rightskip}{0pt plus 5cm}{\bf SoundListener} $\ast$ phys::SoundManager::GetListener (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_af0c700e283c44c20466185e1150fc6a3}
...
\paragraph[{GetLogs}]{\setlength{\rightskip}{0pt plus 5cm}std::stringstream $\ast$ phys::SoundManager::GetLogs (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_a284fbc2fdbecdf66e717366b09e2c9da}
...
\paragraph[{GetSoundByName}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Sound} $\ast$ phys::SoundManager::GetSoundByName (
\begin{DoxyParamCaption}
\item[{{\bf String}}]{SoundName}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_aa325440a688757ad74812b7f093e2423}
...
Definition at line 148 of file soundmanager.cpp.
...
\paragraph[{GetSoundSet}]{\setlength{\rightskip}{0pt plus 5cm}{\bf SoundSet} $\ast$ phys::SoundManager::GetSoundSet (
\begin{DoxyParamCaption}
\item[{{\bf String}}]{SoundSetName}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1SoundManager_a419edd2aed481ed7eff4beb11c9a6cf2}
...
\paragraph[{GetType}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ManagerBase::ManagerTypeName} phys::SoundManager::GetType (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}\hfill}
\label{classphys_1_1SoundManager_a6815f78a6170b119e2d1d24e862ffbf8}
...
\paragraph[{Initialize}]{\setlength{\rightskip}{0pt plus 5cm}void phys::SoundManager::Initialize (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}\hfill}
\label{classphys_1_1SoundManager_ae6d3957f965b54e06ec540e903cec68d}
...
Definition at line 79 of file soundmanager.cpp.
...
\paragraph[{InitializeManager}]{\setlength{\rightskip}{0pt plus 5cm}void phys::SoundManager::InitializeManager (
\begin{DoxyParamCaption}
...
\label{classphys_1_1SoundManager_a735ca3ad1554d70623ac60f38ca4cefc}
