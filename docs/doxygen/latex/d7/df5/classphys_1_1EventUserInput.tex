...
\subsubsection[{AddCode}]{\setlength{\rightskip}{0pt plus 5cm}{\bf MetaCode} phys::EventUserInput::AddCode (
\begin{DoxyParamCaption}
...
\subsubsection[{AddCodes}]{\setlength{\rightskip}{0pt plus 5cm}void phys::EventUserInput::AddCodes (
\begin{DoxyParamCaption}
...
\subsubsection[{AddCodesFromRawEvent}]{\setlength{\rightskip}{0pt plus 5cm}vector$<$ {\bf MetaCode} $>$ phys::EventUserInput::AddCodesFromRawEvent (
\begin{DoxyParamCaption}
\item[{const {\bf RawEvent} \&}]{ RawEvent\_\-}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{EraseCode}]{\setlength{\rightskip}{0pt plus 5cm}void phys::EventUserInput::EraseCode (
\begin{DoxyParamCaption}
...
\subsubsection[{GetMetaCode}]{\setlength{\rightskip}{0pt plus 5cm}const {\bf MetaCode} \& phys::EventUserInput::GetMetaCode (
\begin{DoxyParamCaption}
\item[{const unsigned int \&}]{ Index}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{GetMetaCodeCount}]{\setlength{\rightskip}{0pt plus 5cm}size\_\-t phys::EventUserInput::GetMetaCodeCount (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{GetType}]{\setlength{\rightskip}{0pt plus 5cm}{\bf EventBase::EventType} phys::EventUserInput::GetType (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
