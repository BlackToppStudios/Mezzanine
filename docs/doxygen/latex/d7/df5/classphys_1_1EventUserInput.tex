...
\index{phys::EventUserInput@{phys::EventUserInput}!getEventType@{getEventType}}
\index{getEventType@{getEventType}!phys::EventUserInput@{phys::EventUserInput}}
\subsubsection[{getEventType}]{\setlength{\rightskip}{0pt plus 5cm}{\bf EventBase::EventType} phys::EventUserInput::getEventType () const\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
