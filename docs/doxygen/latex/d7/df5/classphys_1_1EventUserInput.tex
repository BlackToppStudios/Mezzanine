...
\subsubsection[{AddCode}]{\setlength{\rightskip}{0pt plus 5cm}void phys::EventUserInput::AddCode (
\begin{DoxyParamCaption}
\item[{const {\bf MetaCode} \&}]{ Code\_\-}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{AddCodesFromRawEvent}]{\setlength{\rightskip}{0pt plus 5cm}void phys::EventUserInput::AddCodesFromRawEvent (
\begin{DoxyParamCaption}
\item[{const {\bf RawEvent} \&}]{ RawEvent\_\-}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{operator+=}]{\setlength{\rightskip}{0pt plus 5cm}{\bf EventUserInput} \& phys::EventUserInput::operator+= (
\begin{DoxyParamCaption}
\item[{const {\bf EventUserInput} \&}]{ Add}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{ToggleCode}]{\setlength{\rightskip}{0pt plus 5cm}void phys::EventUserInput::ToggleCode (
\begin{DoxyParamCaption}
\item[{const {\bf MetaCode} \&}]{ Code\_\-}
\end{DoxyParamCaption}
)}}
