...
\hyperlink{structThis}{This} add all of one \hyperlink{classphys_1_1EventUserInput}{EventUserInput} to another. 
...
\hyperlink{structThis}{This} stores the MetaCodes in this event. 
