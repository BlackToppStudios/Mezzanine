...
\subsubsection[{RenderPhysWorld}]{\setlength{\rightskip}{0pt plus 5cm}void PHYS\_\-LIB phys::crossplatform::RenderPhysWorld (World $\ast$ {\em TheWorld}, \/  Ogre::RenderWindow $\ast$ {\em TheOgreWindow})}}
...
\subsubsection[{WaitMilliseconds}]{\setlength{\rightskip}{0pt plus 5cm}void PHYS\_\-LIB phys::crossplatform::WaitMilliseconds (const Whole \& {\em WaitTime})}}
