...
\begin{Desc}
\item[\hyperlink{todo__todo000004}{Todo}]This code was tested and proven to work in test case. Are seperate methods nessessary? Simple investigation showed that the same update() method is called when rendering one frame, but for all targets. \end{Desc}
