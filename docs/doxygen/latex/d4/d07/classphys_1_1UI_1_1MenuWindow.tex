...
\subsubsection[{CreateBackButton}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Button} $\ast$ phys::UI::MenuWindow::CreateBackButton ({\bf Vector2} {\em Position}, \/  {\bf Vector2} {\em Size})\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
...
\subsubsection[{CreateChildMenuWindow}]{\setlength{\rightskip}{0pt plus 5cm}{\bf MenuWindow} $\ast$ phys::UI::MenuWindow::CreateChildMenuWindow ({\bf ConstString} \& {\em Name}, \/  {\bf Vector2} {\em WinPosition}, \/  {\bf Vector2} {\em WinSize}, \/  {\bf Vector2} {\em ButPosition}, \/  {\bf Vector2} {\em ButSize})\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
...
\subsubsection[{GetChildMenuWindow}]{\setlength{\rightskip}{0pt plus 5cm}{\bf MenuWindow} $\ast$ phys::UI::MenuWindow::GetChildMenuWindow ({\bf Whole} {\em Index})\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
