...
\hyperlink{structThis}{This} is a gravity field implementation of the \hyperlink{classphys_1_1AreaEffect}{AreaEffect} class.  
...
\hyperlink{structThis}{This} is a gravity field implementation of the \hyperlink{classphys_1_1AreaEffect}{AreaEffect} class. \hyperlink{structThis}{This} class is not a gravity well, where gravity is pulling to one point. Instead this class uniformly pulls gravity in one direction that is different from the world gravity. 
...
\subsubsection[{ApplyEffect}]{\setlength{\rightskip}{0pt plus 5cm}void phys::GravityField::ApplyEffect ()\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
