...
\hyperlink{structThis}{This} class is used to define area's in the world that have unique effects.  
...
\hyperlink{structThis}{This} class is used to define area's in the world that have unique effects. Common uses for this class are for gravity fields, and explosions. But can be made to do more. \par
 Note: \hyperlink{structThis}{This} is a base class intended to be derived from. \hyperlink{structThis}{This} class cannot be created itself. To make an \hyperlink{classphys_1_1AreaEffect}{AreaEffect} class that does what you want it to, simple inherit from this class with an AE class of your own, and define the \hyperlink{classphys_1_1AreaEffect_a3b285ecfcf9c9200662d510e48dd222a}{ApplyEffect()} function to do what you want your effect to do. 
...
When inheriting this class, this function is what defines the effect the field has. \par
 \hyperlink{structThis}{This} function will be called on by the physics manager and shouldn't be called manually. 
...
\hyperlink{structThis}{This} function assumes the cylinder will be upright, meaning \char`\"{}up\char`\"{} will be on the positive Y axis. \par
...
\hyperlink{structThis}{This} function is particularly useful when making fields such as gravity wells, that have continuous effects centering on one location. \begin{DoxyReturn}{Returns}
...
\hyperlink{structThis}{This} function is automatically called once every simulation step. \hyperlink{structThis}{This} shouldn't be called manually unless your usage of this class requires more then one update per step. 
