...
\label{df/dec/namespacephys_a3d9969958345dec81ed83544445e3c28}
...
\label{df/dec/namespacephys_adbc8714ac6e9a549a5ef261d1bda1505}
...
\label{df/dec/namespacephys_aca0ab1969773dbd0d8799bdd6a5cb745}


Convert any class that supports serialization or has a serializer to a string of chars in a stream. 

Any Class will work with this template as long as it implements the method \char`\"{}xml::Node ProtoSerialize() const\char`\"{} 
\begin{DoxyParams}{Parameters}
{\em Stream} & The ostream to put the serializable into. \\
\hline
{\em Converted} & The item to be serialized, which must have a \char`\"{}xml::Node ProtoSerialize() const\char`\"{} method. \\
\hline
{\em Indent} & Defaults to nothing but can be set to \char`\"{}/t\char`\"{} to get normal \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\label{df/dec/namespacephys_a3d75403c50afb8ed658bb9f22a70939f}
...
\hypertarget{namespacephys_a51e40e4961299527bdb672bb809306f7}{
\index{phys@{phys}!SloppyProtoSerialize@{SloppyProtoSerialize}}
\index{SloppyProtoSerialize@{SloppyProtoSerialize}!phys@{phys}}
\paragraph[{SloppyProtoSerialize}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T $>$ {\bf xml::Node} phys::SloppyProtoSerialize (
\begin{DoxyParamCaption}
\item[{T}]{Converted}
\end{DoxyParamCaption}
)}\hfill}
\label{df/dec/namespacephys_a51e40e4961299527bdb672bb809306f7}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
This returns an \hyperlink{classphys_1_1xml_1_1Node}{xml::Node}. 
\end{DoxyReturn}
...
\label{df/dec/namespacephys_ae78c97cc3fea1bc4cb28ff77e98f4e71}
...
\label{df/dec/namespacephys_a63b5574e497344727dfb4e244511f2fb}
...
\label{df/dec/namespacephys_abf6b30d4f424f33ee4c74d1cb6eca109}
...
\label{df/dec/namespacephys_ae057253f75738c79bc5fdb5f1c5410de}
...
\label{df/dec/namespacephys_aa023584b6c0b8daa4b6abb9108d6e917}
