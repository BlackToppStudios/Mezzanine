...
\subsubsection[{Name}]{\setlength{\rightskip}{0pt plus 5cm}const {\bf char\_\-t}$\ast$ phys::xml::XPathVariable::Name (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}}
...
\subsubsection[{Set}]{\setlength{\rightskip}{0pt plus 5cm}bool phys::xml::XPathVariable::Set (
\begin{DoxyParamCaption}
