...
\begin{DoxyDescription}
\item[Member \hyperlink{classphys_1_1ResourceManager_afa5d686ad3b4c863580050994169cb6b}{phys::ResourceManager::DestroyResourceGroup}(const String \&GroupName) ]This is a bit of a hack, but needs to be here until we can upgrade our resource system. 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[page \hyperlink{index}{Physgame} ]Fill out the Simple Data Types with all the enumerations.
\end{DoxyDescription}