...
This is a convenient base class intended to be used with classes that need to be singletons. This is based on the \hyperlink{namespaceOgre}{Ogre} \hyperlink{classMezzanine_1_1Singleton}{Singleton} class. 
