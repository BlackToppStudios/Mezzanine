...
\subsubsection[{GetMeshIndicies}]{\setlength{\rightskip}{0pt plus 5cm}void phys::ActorBase::GetMeshIndicies ({\bf internal::MeshInfo} \& {\em TheMesh})\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
...
\subsubsection[{GetMeshNormals}]{\setlength{\rightskip}{0pt plus 5cm}void phys::ActorBase::GetMeshNormals ({\bf internal::MeshInfo} \& {\em TheMesh})\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
...
\hyperlink{structThis}{This} function will read the mesh provided and gather the normals of each verticy inside it for re-\/use. 
\begin{DoxyParams}{Parameters}
\item[{\em TheMesh}]The struct to populate with the information gathered. \end{DoxyParams}
...
\subsubsection[{GetMeshTextures}]{\setlength{\rightskip}{0pt plus 5cm}void phys::ActorBase::GetMeshTextures ({\bf internal::MeshInfo} \& {\em TheMesh})\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
...
\subsubsection[{GetMeshVerticies}]{\setlength{\rightskip}{0pt plus 5cm}void phys::ActorBase::GetMeshVerticies ({\bf internal::MeshInfo} \& {\em TheMesh})\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
...
\hyperlink{structThis}{This} function will retrieve the location of the object within the graphical world. \hyperlink{structThis}{This} should always match the physics world. \begin{DoxyReturn}{Returns}
...
\subsubsection[{GetOtherMeshInfo}]{\setlength{\rightskip}{0pt plus 5cm}void phys::ActorBase::GetOtherMeshInfo ({\bf internal::MeshInfo} \& {\em TheMesh})\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
...
\hyperlink{structThis}{This} function will get the Render Operation, Material Name, and Entity Name from the entity for re-\/use. 
\begin{DoxyParams}{Parameters}
\item[{\em TheMesh}]The struct to populate with the information gathered. \end{DoxyParams}
...
\hyperlink{structThis}{This} function will set the Friction and Resititution of the actor, which will enable it to collide and interact with other actors in a game world more realistically. 
\begin{DoxyParams}{Parameters}
...
\hyperlink{structThis}{This} function will set the object to a Kinematic Object. \par
