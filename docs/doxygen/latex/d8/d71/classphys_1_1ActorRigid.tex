...
\subsubsection[{PerformConvexDecomposition}]{\setlength{\rightskip}{0pt plus 5cm}void phys::ActorRigid::PerformConvexDecomposition (unsigned int {\em depth}, \/  float {\em cpercent}, \/  float {\em ppercent})\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
