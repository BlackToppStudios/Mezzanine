...
\hyperlink{structThis}{This} is the actor class for Rigid Objects.  
...
\begin{DoxyCompactList}\small\item\em Sets the Damping for this object.  Both of Linear Damping and Angular Damping default to zero. \hyperlink{structThis}{This} is usful if you wish to simulate something like air resistance. Values can range from 0.0 to 1.0. \item\end{DoxyCompactList}\item 
...
\hyperlink{structThis}{This} is the actor class for Rigid Objects. \hyperlink{structThis}{This} class should be used to make any rigid object that can be moved as a result of force. Most objects will fall into this catagory. A few examples of a Rigid Object: Boxes, Car Frames, Chairs, etc. For Semi Rigid bodies that are deformable, like jello, it is better to use \hyperlink{classphys_1_1ActorSoft}{ActorSoft}. 
...
\hyperlink{structThis}{This} constructor contains the basic information needed to make a Rigid Object. \par
 \hyperlink{structThis}{This} class inherits from \hyperlink{classphys_1_1ActorBase}{ActorBase}. 
...
\subsubsection[{AddObjectToWorld}]{\setlength{\rightskip}{0pt plus 5cm}void phys::ActorRigid::AddObjectToWorld ({\bf World} $\ast$ {\em TargetWorld})\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
...
Definition at line 166 of file actorrigid.cpp.
...
Creates a rigid object to be placed in the physics world later. \par
 \hyperlink{structThis}{This} is automaticly called by the Constructor and shouldn't be called manually. 
\begin{DoxyParams}{Parameters}
...
Definition at line 180 of file actorrigid.cpp.
...
Definition at line 305 of file actorrigid.cpp.
...
Definition at line 275 of file actorrigid.cpp.
...
\hyperlink{structThis}{This} function is useful when using constraints to prevent it from locking in situations where it shouldn't. 

Definition at line 359 of file actorrigid.cpp.
...
Definition at line 353 of file actorrigid.cpp.
...
Definition at line 342 of file actorrigid.cpp.
...
\subsubsection[{GetName}]{\setlength{\rightskip}{0pt plus 5cm}std::string phys::ActorRigid::GetName () const\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
...
Definition at line 320 of file actorrigid.cpp.
...
\hyperlink{structThis}{This} function will lock any and all axies you define you want to be locked. Simply pass true to allow movement on that axis, false if you don't. \hyperlink{structThis}{This} function is primarily useful for 2D games, in which if you are viewing the playing area from the side you can pass in LimitMovementOnAxis(true,true,false) and the object will only be able to move up, down, or side to side, but not in or out. 
\begin{DoxyParams}{Parameters}
...
Definition at line 325 of file actorrigid.cpp.
...
\subsubsection[{RemoveObjectFromWorld}]{\setlength{\rightskip}{0pt plus 5cm}void phys::ActorRigid::RemoveObjectFromWorld ({\bf World} $\ast$ {\em TargetWorld})\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
...
Definition at line 173 of file actorrigid.cpp.
...
\hyperlink{structThis}{This} function is useful when you are done applying a constraint to a body, or any other effect that would have you call \hyperlink{classphys_1_1ActorRigid_ad74da4da12bbb44b3e5ae22007c98573}{DisableDeactivation()}. 

Definition at line 364 of file actorrigid.cpp.
...
Definition at line 348 of file actorrigid.cpp.
...
Sets the Damping for this object.  Both of Linear Damping and Angular Damping default to zero. \hyperlink{structThis}{This} is usful if you wish to simulate something like air resistance. Values can range from 0.0 to 1.0. 
...
Definition at line 332 of file actorrigid.cpp.
...
Definition at line 337 of file actorrigid.cpp.
