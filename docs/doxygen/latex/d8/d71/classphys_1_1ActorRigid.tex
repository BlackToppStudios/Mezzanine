...
Both of Linear Damping and Angular Damping default to zero. \hyperlink{structThis}{This} is usful if you wish to simulate something like air resistance. Values can range from 0.0 to 1.0. 
\begin{DoxyParams}{Parameters}
