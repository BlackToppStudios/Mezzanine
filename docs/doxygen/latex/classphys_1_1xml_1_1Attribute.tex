...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000046}{Todo}]update this to make the error return code redudant and use an exception instead. \end{Desc}
...
\end{DoxyWarning}
\begin{Desc}
\item[\hyperlink{todo__todo000038}{Todo}]Strip \char`\"{}$>$\char`\"{} automatically and provide a method to reconsitute it. \end{Desc}
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000033}{Todo}]update this to make the error return code redundant and use an exception instead. 
