...
\label{classphys_1_1xml_1_1Attribute}\index{phys::xml::Attribute@{phys::xml::Attribute}}
}
...
\begin{DoxyCompactList}\small\item\em Compares the internal values to check for inequality. \item\end{DoxyCompactList}\item 
bool \hyperlink{classphys_1_1xml_1_1Attribute_aa13155b9c933ec5668938c348505c901}{SetName} (const \hyperlink{namespacephys_1_1xml_a4d8ca7638328d16d303e5a4c849f4704}{String} \&rhs)
\begin{DoxyCompactList}\small\item\em Set the name of this object. \item\end{DoxyCompactList}\item 
bool \hyperlink{classphys_1_1xml_1_1Attribute_a958c03be304baa9e565b21c614721498}{SetName} (const \hyperlink{namespacephys_1_1xml_afc87705cd1c2917d87b879715a2d8f6e}{char\_\-t} $\ast$rhs)
...
\label{classphys_1_1xml_1_1Attribute_a1ed8790083a80b2604beba1c666bce6e}

\item 
\hypertarget{classphys_1_1xml_1_1Attribute_a6db9d28bd448a131448276ee03de1e6d}{
class {\bfseries Node}}
\label{classphys_1_1xml_1_1Attribute_a6db9d28bd448a131448276ee03de1e6d}
...
\paragraph[{Attribute}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::Attribute (
\begin{DoxyParamCaption}
\item[{{\bf AttributeStruct} $\ast$}]{attr}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}explicit\mbox{]}}}\hfill}
\label{classphys_1_1xml_1_1Attribute_a6786df9d66c675c5a55761a7d3d512a5}
...
\paragraph[{AsBool}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::AsBool (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_a1c3e0f3a1722aac6a43daa135fdf622e}
...
\paragraph[{AsDouble}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::AsDouble (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_a467ae167d5407ae3293a22b8873cb43a}
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000046}{Todo}]Update \hyperlink{classphys_1_1xml_1_1Attribute_a467ae167d5407ae3293a22b8873cb43a}{Attribute::AsDouble()} to check errno and throw exceptions were appropriate, and throw a exception on failure instead of producing a valid return value. \end{Desc}
...
\paragraph[{AsFloat}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::AsFloat (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_aad74f805b9318735011d698ee39113aa}
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000047}{Todo}]Update \hyperlink{classphys_1_1xml_1_1Attribute_aad74f805b9318735011d698ee39113aa}{Attribute::AsFloat()} to check errno and throw exceptions were appropriate, and throw a exception on failure instead of producing a valid return value. \end{Desc}
\begin{DoxyWarning}{Warning}
...
\paragraph[{AsInt}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::AsInt (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_ada1f2e45ce636ad8482972263364e7fa}
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000044}{Todo}]Update \hyperlink{classphys_1_1xml_1_1Attribute_ada1f2e45ce636ad8482972263364e7fa}{Attribute::AsInt()} to check errno and throw exceptions were appropriate, and throw a exception on failure instead of producing a valid return value. \end{Desc}
\begin{DoxyWarning}{Warning}
...
\paragraph[{AsInteger}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::AsInteger (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_a6f7ae9a3fe3ad8d88823d97e8fa04973}
...
\paragraph[{AsReal}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::AsReal (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_a1ed9ffa5461223647168309ae4c86809}
...
\paragraph[{AsString}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::AsString (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_a7b6b2e3e8c8f262dfca1b97d904c638a}
...
\paragraph[{AsUint}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::AsUint (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_ad00ec5857fc4afcda892a0057419a9a0}
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000045}{Todo}]Update \hyperlink{classphys_1_1xml_1_1Attribute_ad00ec5857fc4afcda892a0057419a9a0}{Attribute::AsUint()} to check errno and throw exceptions were appropriate, and throw a exception on failure instead of producing a valid return value. \end{Desc}
\begin{DoxyWarning}{Warning}
This may silently fail if the value of the attribute exceeds the maximum value that can be stored in and int. Check \char`\"{}errno\char`\"{} and see if it is set to \char`\"{}ERANGE\char`\"{} to test for this condition. 
\end{DoxyWarning}
...
\paragraph[{AsWhole}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::AsWhole (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_ac40df65f4914609554d99e72624eb8d2}
...
\paragraph[{Empty}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::Empty (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_a6d0157a562f283e9c87d1cc46b3405cc}
...
\paragraph[{GetNextAttribute}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::GetNextAttribute (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_a602c51cb79ed0cc33bd898aefe77da70}
...
\paragraph[{GetPreviousAttribute}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::GetPreviousAttribute (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_ae1c2320961faca954e7e34acc166f8d0}
...
\paragraph[{HashValue}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::HashValue (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_ac0c27e07b705c41670a0903f4fe18378}
...
\paragraph[{InternalObject}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::InternalObject (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_a1354d5f93309a999651e11b1cd4c2f62}
...
\paragraph[{Name}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::Name (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_ab4c1186366d975d2086bf81df2ce1135}
...
\paragraph[{operator unspecified\_\-bool\_\-type}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::operator unspecified\_\-bool\_\-type (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_a95fb020caed5a4ec9a5248fe38d6f345}
...
\paragraph[{operator!}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::operator! (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_a18cb9f6900b0fc9e246b36d90e5bea5b}
...
\label{classphys_1_1xml_1_1Attribute_ae2371203e07dd781d2b38ba403b00816}
...
\begin{DoxyParams}{Parameters}
{\em r} & The other \hyperlink{classphys_1_1xml_1_1Attribute}{Attribute} this is being compared to.\\
\hline
\end{DoxyParams}
...
\label{classphys_1_1xml_1_1Attribute_ac383f0c514e550fe992b1c0a0f3cbd7a}
...
\label{classphys_1_1xml_1_1Attribute_a3b73bd409a2b6b9a7d72c3affc96bae1}
...
\label{classphys_1_1xml_1_1Attribute_ac9a18c2b6c4bfc0cdfe4eede938a91fe}
...
\label{classphys_1_1xml_1_1Attribute_ac92a92492d624984a52b64bc4fabf355}
...
\label{classphys_1_1xml_1_1Attribute_a008397ad3c9c63bf27a4dca4b68e5efd}
...
\label{classphys_1_1xml_1_1Attribute_af6b6e5202b23be948b986cb0bcdf5da8}
...
\label{classphys_1_1xml_1_1Attribute_a78d7a0436d386040e2d1f8954304b25b}
...
\label{classphys_1_1xml_1_1Attribute_a68b6ba1299cc9a2019ec97b10bb8978b}
...
\label{classphys_1_1xml_1_1Attribute_ac778ad4d7aa3a179217de1425e220848}
...
\label{classphys_1_1xml_1_1Attribute_ab1d63c57891107848492dc3316c95455}
...
\end{DoxyReturn}
\hypertarget{classphys_1_1xml_1_1Attribute_aa13155b9c933ec5668938c348505c901}{
\index{phys::xml::Attribute@{phys::xml::Attribute}!SetName@{SetName}}
\index{SetName@{SetName}!phys::xml::Attribute@{phys::xml::Attribute}}
\paragraph[{SetName}]{\setlength{\rightskip}{0pt plus 5cm}bool phys::xml::Attribute::SetName (
\begin{DoxyParamCaption}
\item[{const {\bf String} \&}]{rhs}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}\hfill}
\label{classphys_1_1xml_1_1Attribute_aa13155b9c933ec5668938c348505c901}
...
\label{classphys_1_1xml_1_1Attribute_a958c03be304baa9e565b21c614721498}
...
\paragraph[{SetValue}]{\setlength{\rightskip}{0pt plus 5cm}bool phys::xml::Attribute::SetValue (
\begin{DoxyParamCaption}
\item[{bool}]{rhs}
\end{DoxyParamCaption}
)}\hfill}
\label{classphys_1_1xml_1_1Attribute_a6df4cf0f083482e69e4e6e94599a1d82}
...
\label{classphys_1_1xml_1_1Attribute_a693f7bd8015866c3c4979101c343ce50}
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000037}{Todo}]update this to make the error return code redundant and use an exception instead. 
...
\label{classphys_1_1xml_1_1Attribute_a289ac36b218f3912224fd904ccade1ed}
...
\label{classphys_1_1xml_1_1Attribute_a919034671f61ee408d616409a49dafca}
...
\label{classphys_1_1xml_1_1Attribute_a470512fcd8b4f7609319bf85df100aaa}
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000036}{Todo}]update this to make the error return code redundant and use an exception instead. 

Review for possiblity of buffer overflow. \end{Desc}
\hypertarget{classphys_1_1xml_1_1Attribute_af9b12723a227b833d7f8986a524b0e48}{
\index{phys::xml::Attribute@{phys::xml::Attribute}!SetValue@{SetValue}}
\index{SetValue@{SetValue}!phys::xml::Attribute@{phys::xml::Attribute}}
\paragraph[{SetValue}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T $>$ bool phys::xml::Attribute::SetValue (
\begin{DoxyParamCaption}
\item[{T}]{rhs}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}\hfill}
\label{classphys_1_1xml_1_1Attribute_af9b12723a227b833d7f8986a524b0e48}
...
\end{DoxyWarning}
\begin{Desc}
\item[\hyperlink{todo__todo000041}{Todo}]Strip \char`\"{}$>$\char`\"{} automatically and provide a method to reconsitute it. \end{Desc}
...
\paragraph[{Value}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::Attribute::Value (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hfill}
\label{classphys_1_1xml_1_1Attribute_a8a8099b39bca8894a8226ce0e82d3451}
