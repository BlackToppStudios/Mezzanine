...
\subsubsection[{EvaluateBoolean}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::XPathQuery::EvaluateBoolean (
\begin{DoxyParamCaption}
\item[{const {\bf XPathNode} \&}]{ n}
\end{DoxyParamCaption}
) const}}
\label{de/d52/classphys_1_1xml_1_1XPathQuery_a44fed594a458aa4b6cf4f3d12d5089a8}
...
\begin{DoxyParams}{Parameters}
\item[{\em n}]The \hyperlink{classphys_1_1xml_1_1XPathNode}{XPathNode} that will serve as the context for the query. \end{DoxyParams}


Definition at line 9501 of file xml.cpp.
...
\subsubsection[{EvaluateNodeSet}]{\setlength{\rightskip}{0pt plus 5cm}{\bf XPathNodeSet} phys::xml::XPathQuery::EvaluateNodeSet (
\begin{DoxyParamCaption}
\item[{const {\bf XPathNode} \&}]{ n}
\end{DoxyParamCaption}
) const}}
...
\begin{DoxyParams}{Parameters}
\item[{\em n}]The \hyperlink{classphys_1_1xml_1_1XPathNode}{XPathNode} that with serve as the context for the query. \end{DoxyParams}

\begin{DoxyExceptions}{Exceptions}
\item[{\em If}]XML\_\-NO\_\-EXCEPTIONS is not defined (by default it is not defined), throws throws \hyperlink{classphys_1_1xml_1_1XPathException}{XPathException} on Type mismatch and std::bad\_\-alloc on out of memory errors. If XML\_\-NO\_\-EXCEPTIONS is defined, returns empty node set instead. \end{DoxyExceptions}
\begin{DoxyReturn}{Returns}
An \hyperlink{classphys_1_1xml_1_1XPathNodeSet}{XPathNodeSet}. 
\end{DoxyReturn}


Definition at line 9558 of file xml.cpp.
...
\subsubsection[{EvaluateNumber}]{\setlength{\rightskip}{0pt plus 5cm}double phys::xml::XPathQuery::EvaluateNumber (
\begin{DoxyParamCaption}
\item[{const {\bf XPathNode} \&}]{ n}
\end{DoxyParamCaption}
) const}}
...
\begin{DoxyExceptions}{Exceptions}
\item[{\em If}]XML\_\-NO\_\-EXCEPTIONS is not defined (by default it is not defined), throws std::bad\_\-alloc on out of memory errors. \end{DoxyExceptions}
\begin{DoxyReturn}{Returns}
A result as a double from evaluating the expression. 
\end{DoxyReturn}


Definition at line 9515 of file xml.cpp.
...
\subsubsection[{EvaluateString}]{\setlength{\rightskip}{0pt plus 5cm}String phys::xml::XPathQuery::EvaluateString (
\begin{DoxyParamCaption}
\item[{const {\bf XPathNode} \&}]{ n}
\end{DoxyParamCaption}
) const}}
...
Definition at line 9530 of file xml.cpp.

\hypertarget{classphys_1_1xml_1_1XPathQuery_ac9f4705c639cbd7f3aef8266fa683cc2}{
\index{phys::xml::XPathQuery@{phys::xml::XPathQuery}!EvaluateString@{EvaluateString}}
\index{EvaluateString@{EvaluateString}!phys::xml::XPathQuery@{phys::xml::XPathQuery}}
\subsubsection[{EvaluateString}]{\setlength{\rightskip}{0pt plus 5cm}size\_\-t phys::xml::XPathQuery::EvaluateString (
\begin{DoxyParamCaption}
...
\begin{DoxyParams}{Parameters}
\item[{\em buffer}]The place to store the c-\/style Character array \item[{\em capacity}]At most capacity characters are written to the destination buffer. \item[{\em n}]The \hyperlink{classphys_1_1xml_1_1XPathNode}{XPathNode} that with serve as the context for the query. \end{DoxyParams}

\begin{DoxyExceptions}{Exceptions}
\item[{\em If}]XML\_\-NO\_\-EXCEPTIONS is not defined (by default it is not defined), throws std::bad\_\-alloc on out of memory errors. If XML\_\-NO\_\-EXCEPTIONS is defined, this returns empty set instead. \end{DoxyExceptions}
\begin{DoxyReturn}{Returns}
Full result size is returned (includes terminating zero). 
\end{DoxyReturn}


Definition at line 9538 of file xml.cpp.
...
\subsubsection[{operator!}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::XPathQuery::operator! (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}}
\label{de/d52/classphys_1_1xml_1_1XPathQuery_afe0b62e0ab607855f5267b0690bda33b}
...
Definition at line 9598 of file xml.cpp.

\hypertarget{classphys_1_1xml_1_1XPathQuery_a83f2039e91105c9cd0dcc7d524359198}{
\index{phys::xml::XPathQuery@{phys::xml::XPathQuery}!Result@{Result}}
\index{Result@{Result}!phys::xml::XPathQuery@{phys::xml::XPathQuery}}
\subsubsection[{Result}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::XPathQuery::Result (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}}
\label{de/d52/classphys_1_1xml_1_1XPathQuery_a83f2039e91105c9cd0dcc7d524359198}


Get parsing Result (used to get compilation errors when XML\_\-NO\_\-EXCEPTIONS is enabled). 
...
Definition at line 9588 of file xml.cpp.
...
\subsubsection[{ReturnType}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::XPathQuery::ReturnType (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}}
\label{de/d52/classphys_1_1xml_1_1XPathQuery_af4c6025009b1e09cdf56124a047ca4f0}
...
Definition at line 9494 of file xml.cpp.
