...
Definition at line 58 of file actorterrain.h.
...
\subsubsection[{ActorTerrain}]{\setlength{\rightskip}{0pt plus 5cm}phys::ActorTerrain::ActorTerrain (
...
\label{de/d74/classphys_1_1ActorTerrain_af0d3b88d5ee409c5451bb13a20254176}
...
\item[{\em InitPosition}]The location for this terrain. \item[{\em name}]The name of the actor. \item[{\em file}]The 3d mesh file that contains the 3d model the actor will use. \item[{\em group}]The resource group where the 3d mesh and other related files can be found. \end{DoxyParams}


Definition at line 56 of file actorterrain.cpp.
...
Definition at line 65 of file actorterrain.cpp.
...
\subsubsection[{AddObjectToWorld}]{\setlength{\rightskip}{0pt plus 5cm}void phys::ActorTerrain::AddObjectToWorld (
\begin{DoxyParamCaption}
...
Definition at line 106 of file actorterrain.cpp.
...
\subsubsection[{CreateShapeFromMeshDynamic}]{\setlength{\rightskip}{0pt plus 5cm}void phys::ActorTerrain::CreateShapeFromMeshDynamic (
\begin{DoxyParamCaption}
\item[{short unsigned int}]{ Accuracy, }
\item[{bool}]{ UseAllSubmeshes = {\ttfamily false}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
\label{de/d74/classphys_1_1ActorTerrain_a9fed38501411c0cf7a1e9f4f36af6ac7}
...
Definition at line 97 of file actorterrain.cpp.
...
\label{de/d74/classphys_1_1ActorTerrain_aaed245d7af66230aaabb02a84e891bb0}
...
Definition at line 82 of file actorterrain.cpp.
...
\subsubsection[{GetBulletObject}]{\setlength{\rightskip}{0pt plus 5cm}btRigidBody $\ast$ phys::ActorTerrain::GetBulletObject (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
...
Definition at line 120 of file actorterrain.cpp.
...
\subsubsection[{GetName}]{\setlength{\rightskip}{0pt plus 5cm}std::string phys::ActorTerrain::GetName (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
Definition at line 101 of file actorterrain.cpp.
...
\subsubsection[{RemoveObjectFromWorld}]{\setlength{\rightskip}{0pt plus 5cm}void phys::ActorTerrain::RemoveObjectFromWorld (
\begin{DoxyParamCaption}
\item[{{\bf World} $\ast$}]{ TargetWorld}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
...
\index{phys::ActorTerrain@{phys::ActorTerrain}!RigidBody@{RigidBody}}
\index{RigidBody@{RigidBody}!phys::ActorTerrain@{phys::ActorTerrain}}
\subsubsection[{RigidBody}]{\setlength{\rightskip}{0pt plus 5cm}btRigidBody$\ast$ {\bf phys::ActorTerrain::RigidBody}\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
