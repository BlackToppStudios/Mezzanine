...
Definition at line 191 of file constraint.cpp.
...
\index{phys::Generic6DofConstraint@{phys::Generic6DofConstraint}!GetParam@{GetParam}}
\index{GetParam@{GetParam}!phys::Generic6DofConstraint@{phys::Generic6DofConstraint}}
\subsubsection[{GetParam}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Real} phys::Generic6DofConstraint::GetParam (int {\em num}, \/  int {\em axis} = {\ttfamily -\/1})\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
...
\index{phys::Generic6DofConstraint@{phys::Generic6DofConstraint}!SetParam@{SetParam}}
\index{SetParam@{SetParam}!phys::Generic6DofConstraint@{phys::Generic6DofConstraint}}
\subsubsection[{SetParam}]{\setlength{\rightskip}{0pt plus 5cm}void phys::Generic6DofConstraint::SetParam (int {\em num}, \/  {\bf Real} {\em value}, \/  int {\em axis} = {\ttfamily -\/1})\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
