...
\subsubsection[{Generic6DofConstraint}]{\setlength{\rightskip}{0pt plus 5cm}phys::Generic6DofConstraint::Generic6DofConstraint (
\begin{DoxyParamCaption}
\item[{btGeneric6DofConstraint $\ast$}]{ Constraint}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{GetParam}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Real} phys::Generic6DofConstraint::GetParam (
\begin{DoxyParamCaption}
\item[{int}]{ num, }
...
\subsubsection[{SetParam}]{\setlength{\rightskip}{0pt plus 5cm}void phys::Generic6DofConstraint::SetParam (
\begin{DoxyParamCaption}
\item[{int}]{ num, }
\item[{{\bf Real}}]{ value, }
\item[{int}]{ axis = {\ttfamily -\/1}}
