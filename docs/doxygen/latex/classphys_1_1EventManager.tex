...
\begin{DoxyCompactList}\small\item\em This returns a complete list of all the Collision Events. \item\end{DoxyCompactList}\item 
...
This finds all the Collision Events then creates a new list and returns that. This runs in linear time relative to the amounts of events. \begin{DoxyReturn}{Returns}
