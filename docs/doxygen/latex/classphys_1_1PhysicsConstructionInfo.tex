...
\begin{DoxyCompactList}\small\item\em The amount of force a collision has to have to generate an event for it. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
