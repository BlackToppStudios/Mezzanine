...
\begin{DoxyReturn}{Returns}
Returns a \hyperlink{classvector3}{vector3} with the scale being applied to each axis. 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
{\em Scale} & A \hyperlink{classvector3}{vector3} with the scales that will be applied to each axis. \\
\hline
\end{DoxyParams}
