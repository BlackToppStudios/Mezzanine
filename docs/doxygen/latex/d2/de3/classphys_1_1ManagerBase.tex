...
\hyperlink{structThis}{This} is the base class from which all the \hyperlink{classphys_1_1World}{World} Managers inherit.  
...
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} makes working with Callback function pointer a bit easier. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} gets the \hyperlink{classphys_1_1World}{World} that this manager is working with. \item\end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} assigns a function to be the callback function to run prior to the main loop. \item\end{DoxyCompactList}\item 
virtual bool \hyperlink{classphys_1_1ManagerBase_af6210834a8af592481cf6aefa9916d88}{PreMainLoopItems} ()
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} runs any callback that is required before the mainloop items are run. \item\end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} returns the Callback that would be called before the main loop items. \item\end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} simply calls \hyperlink{classphys_1_1ManagerBase_a3fcf207a451d0047f884babadd0bc53e}{SetPreMainLoopItems()} passing it 0. \item\end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} runs any callback that is required after the mainloop items are run. \item\end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} simply calls \hyperlink{classphys_1_1ManagerBase_a673b3adef73c467f4d90514a5133bf7c}{SetPostMainLoopItems()} passing it 0. \item\end{DoxyCompactList}\item 
virtual short int \hyperlink{classphys_1_1ManagerBase_af1798db3b808a658bdf14d8914d9b91d}{GetPriority} ()
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} gets the Priority of this manager. \item\end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} Allows any manager to be sent to a stream. Primarily used for logging. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} is a function pointer to the function that should be called before running Main Loop Items. \item\end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} is a function pointer to the function that should be called after running Main Loop Items. \item\end{DoxyCompactList}\item 
short int \hyperlink{classphys_1_1ManagerBase_a28e2690fbcf644a7780a53b81821d8ef}{Priority}
\begin{DoxyCompactList}\small\item\em \hyperlink{structThis}{This} is a weighting used by the main loop to decide what order the managers should be called in. \item\end{DoxyCompactList}\end{DoxyCompactItemize}


\subsection{Detailed Description}
\hyperlink{structThis}{This} is the base class from which all the \hyperlink{classphys_1_1World}{World} Managers inherit. \hyperlink{structThis}{This} creates a base set of functions that Managers are all expected to implement. 
...
}]\hyperlink{structThis}{This} is what User created managers that do not derive from any other managers are expected to use to prevent confusion with game internals. \end{description}
\end{Desc}
...
\hyperlink{structThis}{This} is the prefered constructor. \hyperlink{structThis}{This} is used to \char`\"{}Attach\char`\"{} a manager to a phys::world. \hyperlink{structThis}{This} is expected to configure everything that this manager will need except for items requiring integration with other managers. 
\begin{DoxyParams}{Parameters}
\item[{\em GameWorld\_\-}]\hyperlink{structThis}{This} is the \hyperlink{classphys_1_1World}{phys::World} this Manager is expected to work with. \end{DoxyParams}
...
\hyperlink{structThis}{This} is actuall 
...
\hyperlink{structThis}{This} gets the \hyperlink{classphys_1_1World}{World} that this manager is working with. 

\begin{DoxyReturn}{Returns}
\hyperlink{structThis}{This} returns a \hyperlink{classphys_1_1World}{phys::World}$\ast$ that is the same as the one store in this Manager 
\end{DoxyReturn}
...
\hyperlink{structThis}{This} returns the Callback that would be called before the main loop items. 

\begin{DoxyReturn}{Returns}
\hyperlink{structThis}{This} returns a \hyperlink{classphys_1_1ManagerBase_a753f5f0127131529767beab2502f480b}{ManagerBase::Callback} which is a p ointer to the callback function that will be called after the main loop items 
\end{DoxyReturn}
...
\begin{DoxyReturn}{Returns}
\hyperlink{structThis}{This} returns a \hyperlink{classphys_1_1ManagerBase_a753f5f0127131529767beab2502f480b}{ManagerBase::Callback} which is a pointer to the callback function that will be called before the main loop items 
\end{DoxyReturn}
...
\hyperlink{structThis}{This} gets the Priority of this manager. 

\hyperlink{structThis}{This} has no Set counterpart to allow the changing of a manager's priority. \hyperlink{structThis}{This} is expected to be set by the manager, or expose a safe method to change it at that level. \begin{DoxyReturn}{Returns}
\hyperlink{structThis}{This} returns a short int that represents the priority of the manager. Lower is executed first. 
\end{DoxyReturn}
...
\hyperlink{structThis}{This} Allows any manager to be sent to a stream. Primarily used for logging. 

\begin{DoxyReturn}{Returns}
\hyperlink{structThis}{This} returns a std::ostream\& that contains the name, and maybe some data for the the streammed manager. 
\end{DoxyReturn}
...
\hyperlink{structThis}{This} runs any callback that is required after the mainloop items are run. 

\hyperlink{structThis}{This} will return whatever the callback returns, which is true to end the main loop after this frame, or true to continue it. If no callback is set this simply returns true, as to not interupt the mainloop. \par
 \hyperlink{structThis}{This} is a great Function to override in Manager classes where the complexity of callbacks is not required. \hyperlink{structThis}{This} would make coding items that need to be performed at specific times easier. If you do that, it would be a good idea to call this version of the function, just in case a callback is set. \begin{DoxyReturn}{Returns}
\hyperlink{structThis}{This} returns a false to end the main loop, or a true if the main loop should continue. 
\end{DoxyReturn}
...
\hyperlink{structThis}{This} runs any callback that is required before the mainloop items are run. 
...
\hyperlink{structThis}{This} assigns a function to be the callback function to run prior to the main loop. 


\begin{DoxyParams}{Parameters}
\item[{\em PostMainCallback}]\hyperlink{structThis}{This} is a pointer to a function that returns a bool and accepts no arguments, this is in the form of a \hyperlink{classphys_1_1ManagerBase_a753f5f0127131529767beab2502f480b}{ManagerBase::Callback}. If SetPosMainLoopItems is passed 0, NULL or a null pointer, the callback will be forgetten and will not attempt to be called. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em PreMainCallback}]\hyperlink{structThis}{This} is a pointer to a function that returns a bool and accepts no arguments, this is in the form of a \hyperlink{classphys_1_1ManagerBase_a753f5f0127131529767beab2502f480b}{ManagerBase::Callback}. If SetPreMainLoopItems is passed 0, NULL or a null pointer, the callback will be forgetten and will not attempt to be called. \end{DoxyParams}
...
Definition at line 199 of file managerbase.h.
...
\hyperlink{structThis}{This} is a function pointer to the function that should be called after running Main Loop Items. 

\begin{DoxyInternal}{For internal use only.}
\end{DoxyInternal}


Definition at line 207 of file managerbase.h.
...
\hyperlink{structThis}{This} is a function pointer to the function that should be called before running Main Loop Items. 

\begin{DoxyInternal}{For internal use only.}
\end{DoxyInternal}


Definition at line 203 of file managerbase.h.
...
\hyperlink{structThis}{This} is a weighting used by the main loop to decide what order the managers should be called in. 

A lower number gets called earlier in the Main loop. By default rendering the graphics occurs at priority 0. 

Definition at line 212 of file managerbase.h.
