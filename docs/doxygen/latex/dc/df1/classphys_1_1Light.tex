...
\begin{DoxyParams}{Parameters}
\item[{\em light}]The \hyperlink{namespaceOgre}{Ogre} light this class is based on. \item[{\em manager}]Pointer to the manager that this light is to be used in. \end{DoxyParams}
...
\subsubsection[{GetName}]{\setlength{\rightskip}{0pt plus 5cm}{\bf String} \& phys::Light::GetName (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\index{phys::Light@{phys::Light}!Node@{Node}}
\index{Node@{Node}!phys::Light@{phys::Light}}
