...
\index{Mezzanine::ActorRigidPhysicsSettings@{Mezzanine::ActorRigidPhysicsSettings}!$\sim$ActorRigidPhysicsSettings@{$\sim$ActorRigidPhysicsSettings}}
\index{$\sim$ActorRigidPhysicsSettings@{$\sim$ActorRigidPhysicsSettings}!Mezzanine::ActorRigidPhysicsSettings@{Mezzanine::ActorRigidPhysicsSettings}}
\paragraph[{$\sim$ActorRigidPhysicsSettings}]{\setlength{\rightskip}{0pt plus 5cm}Mezzanine::ActorRigidPhysicsSettings::$\sim$ActorRigidPhysicsSettings (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\begin{Desc}
\item[\hyperlink{todo__todo000001}{Todo}]Occasionally a SIGTRAP occurs here without any breakpoint set while debugging. Needs to be fixed. on Linux it is a SIGSEGV. \end{Desc}
...
\hypertarget{classMezzanine_1_1ActorRigidPhysicsSettings_a3858fe916114998aee33005fd2a968e7}{
\index{Mezzanine::ActorRigidPhysicsSettings@{Mezzanine::ActorRigidPhysicsSettings}!ProtoDeSerialize@{ProtoDeSerialize}}
\index{ProtoDeSerialize@{ProtoDeSerialize}!Mezzanine::ActorRigidPhysicsSettings@{Mezzanine::ActorRigidPhysicsSettings}}
\paragraph[{ProtoDeSerialize}]{\setlength{\rightskip}{0pt plus 5cm}void Mezzanine::ActorRigidPhysicsSettings::ProtoDeSerialize (
\begin{DoxyParamCaption}
\item[{const {\bf xml::Node} \&}]{OneNode}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}\hfill}
\label{classMezzanine_1_1ActorRigidPhysicsSettings_a3858fe916114998aee33005fd2a968e7}
...
Reimplemented from \hyperlink{classMezzanine_1_1ActorBasePhysicsSettings_a8acd986f63a0c58ad6df9e4d3e291067}{Mezzanine::ActorBasePhysicsSettings}.



Definition at line 365 of file actorphysicssettings.cpp.

\hypertarget{classMezzanine_1_1ActorRigidPhysicsSettings_ab3977a3b5939b9e68657b84b5a80a24d}{
\index{Mezzanine::ActorRigidPhysicsSettings@{Mezzanine::ActorRigidPhysicsSettings}!ProtoSerialize@{ProtoSerialize}}
\index{ProtoSerialize@{ProtoSerialize}!Mezzanine::ActorRigidPhysicsSettings@{Mezzanine::ActorRigidPhysicsSettings}}
\paragraph[{ProtoSerialize}]{\setlength{\rightskip}{0pt plus 5cm}void Mezzanine::ActorRigidPhysicsSettings::ProtoSerialize (
\begin{DoxyParamCaption}
\item[{{\bf xml::Node} \&}]{CurrentRoot}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}\hfill}
\label{classMezzanine_1_1ActorRigidPhysicsSettings_ab3977a3b5939b9e68657b84b5a80a24d}
...
Reimplemented from \hyperlink{classMezzanine_1_1ActorBasePhysicsSettings_ad3c4f8ac2df1c14f9cd498e1a60a34b2}{Mezzanine::ActorBasePhysicsSettings}.



Definition at line 305 of file actorphysicssettings.cpp.

\hypertarget{classMezzanine_1_1ActorRigidPhysicsSettings_a8dab39e71eb26175a3cb4bbb3966c9b1}{
\index{Mezzanine::ActorRigidPhysicsSettings@{Mezzanine::ActorRigidPhysicsSettings}!SerializableName@{SerializableName}}
\index{SerializableName@{SerializableName}!Mezzanine::ActorRigidPhysicsSettings@{Mezzanine::ActorRigidPhysicsSettings}}
\paragraph[{SerializableName}]{\setlength{\rightskip}{0pt plus 5cm}{\bf String} Mezzanine::ActorRigidPhysicsSettings::SerializableName (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}\hfill}
\label{classMezzanine_1_1ActorRigidPhysicsSettings_a8dab39e71eb26175a3cb4bbb3966c9b1}


Get the name of the the XML tag this class will leave behind as its instances are serialized. 

\begin{DoxyReturn}{Returns}
A string containing \char`\"{}ActorRigidPhysicsSettings\char`\"{} 
\end{DoxyReturn}


Reimplemented from \hyperlink{classMezzanine_1_1ActorBasePhysicsSettings_aa386f1bf24f1cc09fceba5d337c3ab29}{Mezzanine::ActorBasePhysicsSettings}.
