...
\subsubsection[{CreateLayer}]{\setlength{\rightskip}{0pt plus 5cm}{\bf UILayer} $\ast$ phys::UIScreen::CreateLayer (const {\bf String} \& {\em Name}, \/  {\bf Whole} {\em Zorder})}}
...
\subsubsection[{GetLayer}]{\setlength{\rightskip}{0pt plus 5cm}{\bf UILayer} $\ast$ phys::UIScreen::GetLayer ({\bf Whole} {\em Index})}}
...
\index{phys::UIScreen@{phys::UIScreen}!GetLayer@{GetLayer}}
\index{GetLayer@{GetLayer}!phys::UIScreen@{phys::UIScreen}}
\subsubsection[{GetLayer}]{\setlength{\rightskip}{0pt plus 5cm}{\bf UILayer} $\ast$ phys::UIScreen::GetLayer (const {\bf String} \& {\em Name})}}
...
\subsubsection[{GetLayerbyZorder}]{\setlength{\rightskip}{0pt plus 5cm}{\bf UILayer} $\ast$ phys::UIScreen::GetLayerbyZorder ({\bf Whole} {\em Zorder})}}
