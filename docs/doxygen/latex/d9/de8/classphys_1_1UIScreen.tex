...
Definition at line 160 of file uiscreen.cpp.
...
\begin{Desc}
\item[\hyperlink{todo__todo000024}{Todo}]add an exception here or maybe log entry, some notification it failed. \end{Desc}
...
Gets an already created layer by index. 
