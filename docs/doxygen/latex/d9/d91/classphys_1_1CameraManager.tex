...
\subsubsection[{CreateCamera}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Camera} $\ast$ phys::CameraManager::CreateCamera (const {\bf String} \& {\em Name})}}
...
\subsubsection[{GetCamera}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Camera} $\ast$ phys::CameraManager::GetCamera ({\bf Whole} {\em Index})}}
...
\index{phys::CameraManager@{phys::CameraManager}!GetCamera@{GetCamera}}
\index{GetCamera@{GetCamera}!phys::CameraManager@{phys::CameraManager}}
\subsubsection[{GetCamera}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Camera} $\ast$ phys::CameraManager::GetCamera (const {\bf String} \& {\em Name})}}
