...
\hyperlink{namespaceOgre}{Ogre} Cam Constructor. 
...
\subsubsection[{GetName}]{\setlength{\rightskip}{0pt plus 5cm}{\bf String} \& phys::Camera::GetName (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
...
\index{phys::Camera@{phys::Camera}!Node@{Node}}
\index{Node@{Node}!phys::Camera@{phys::Camera}}
