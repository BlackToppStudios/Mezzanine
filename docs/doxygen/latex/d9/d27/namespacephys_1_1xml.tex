...
}]Parsing error occurred while parsing CDATA section. \index{StatusBadPcdata@{StatusBadPcdata}!phys::xml@{phys::xml}}\index{phys::xml@{phys::xml}!StatusBadPcdata@{StatusBadPcdata}}\item[{\em 
