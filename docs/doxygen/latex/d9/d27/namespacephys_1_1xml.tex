...
\begin{DoxyCompactItemize}
\item 
std::string PHYS\_\-LIB \hyperlink{namespacephys_1_1xml_a2d4bf28045544dc7350827f568cad46f}{AsUtf8} (const wchar\_\-t $\ast$str)
...
\item 
std::wstring PHYS\_\-LIB \hyperlink{namespacephys_1_1xml_a0a57ef612f499a03733ca18d0e4f0c4f}{AsWide} (const char $\ast$str)
...
String \hyperlink{namespacephys_1_1xml_a9d912900518f0d84d323d1514dfb93a2}{GetOneTag} (std::istream \&stream)
...
\hyperlink{classphys_1_1xml_1_1Document}{Document} $\ast$ \hyperlink{namespacephys_1_1xml_aa48ad222ba9a6fe46a76c2add6923028}{PreParseClassFromSingleTag} (const String \&NameSpace, const String \&ClassName, const String \&OneTag, \hyperlink{namespacephys_a460f6bc24c8dd347b05e0366ae34f34a}{Whole} MinVersion)
...
Definition at line 889 of file xml.h.
...
\subsubsection[{XPathValueType}]{\setlength{\rightskip}{0pt plus 5cm}enum {\bf phys::xml::XPathValueType}}}
...
Definition at line 1019 of file xml.h.
...
\subsubsection[{AsUtf8}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::AsUtf8 (
...
\begin{DoxyParams}{Parameters}
\item[{\em str}]The string to convert \end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\subsubsection[{AsWide}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::AsWide (
\begin{DoxyParamCaption}
...
\subsubsection[{GetMemoryAllocationFunction}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::GetMemoryAllocationFunction (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{GetMemoryDeallocationFunction}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::GetMemoryDeallocationFunction (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
...
\end{DoxyReturn}
\end{DoxyInternal}
\hypertarget{namespacephys_1_1xml_a9d912900518f0d84d323d1514dfb93a2}{
\index{phys::xml@{phys::xml}!GetOneTag@{GetOneTag}}
\index{GetOneTag@{GetOneTag}!phys::xml@{phys::xml}}
\subsubsection[{GetOneTag}]{\setlength{\rightskip}{0pt plus 5cm}String phys::xml::GetOneTag (
\begin{DoxyParamCaption}
\item[{std::istream \&}]{ stream}
\end{DoxyParamCaption}
)}}
\label{d9/d27/namespacephys_1_1xml_a9d912900518f0d84d323d1514dfb93a2}
...
\begin{DoxyParams}{Parameters}
\item[{\em stream}]An std::ostream that contains atleast one xml tag\end{DoxyParams}
This simply returns all the characters from the current point in the stream until the first '$>$' is reached. \begin{DoxyReturn}{Returns}
This returns from the begining of the stream to the first xml tag. 
\end{DoxyReturn}
\hypertarget{namespacephys_1_1xml_aa48ad222ba9a6fe46a76c2add6923028}{
...
\subsubsection[{PreParseClassFromSingleTag}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Document} $\ast$ phys::xml::PreParseClassFromSingleTag (
\begin{DoxyParamCaption}
\item[{const String \&}]{ NameSpace, }
\item[{const String \&}]{ ClassName, }
\item[{const String \&}]{ OneTag, }
\item[{Whole}]{ MinVersion}
\end{DoxyParamCaption}
)}}
\label{d9/d27/namespacephys_1_1xml_aa48ad222ba9a6fe46a76c2add6923028}
...
\begin{DoxyParams}{Parameters}
\item[{\em NameSpace}]Used when throwing exceptions, this is a string containing the namespace and colons of a class to be deserialized for example \char`\"{}phys::\char`\"{} \item[{\em ClassName}]This will be used to identify the main xml element/tag you are attempting to deserialize. This will also be used in error messages. \item[{\em OneTag}]One XML tag/elements worth of text to deserialize. \item[{\em MinVersion}]The minimum version of the xml for the given class that you plan of deserializing. \end{DoxyParams}
\begin{DoxyReturn}{Returns}
An pointer to \hyperlink{classphys_1_1xml_1_1Document}{xml::Document} that you are now the owner of and must delete, that has the data parse and ready to access. 
\end{DoxyReturn}

\begin{DoxyExceptions}{Exceptions}
\item[{\em This}]can throw \end{DoxyExceptions}
\end{DoxyInternal}
...
\subsubsection[{SetMemory\_\-management\_\-functions}]{\setlength{\rightskip}{0pt plus 5cm}phys::xml::SetMemory\_\-management\_\-functions (
\begin{DoxyParamCaption}
