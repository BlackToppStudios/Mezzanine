...
\hyperlink{structThis}{This} communicates the amount of time since the world was rendered.  
...
\hyperlink{structThis}{This} communicates the amount of time since the world was rendered. \hyperlink{structThis}{This} stores in milliseconds the amount of time since the last rendering of the world. 
...
\hyperlink{structThis}{This} is the only way to set the time 
...
\hyperlink{structThis}{This} is primarily for the benefit of sorting thorugh event pointers. If this functions returns EventType::RenderTime, then and event pointer can safely be cast to \hyperlink{classphys_1_1EventRenderTime}{phys::EventRenderTime} . \hyperlink{structThis}{This} method is inherited from phys::Event . 
