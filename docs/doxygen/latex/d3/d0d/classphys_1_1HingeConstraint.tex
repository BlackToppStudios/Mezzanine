...
\begin{center}
\leavevmode
\includegraphics[height=2.000000cm]{d3/d0d/classphys_1_1HingeConstraint}
\end{center}
\end{figure}
...
\subsubsection[{HingeConstraint}]{\setlength{\rightskip}{0pt plus 5cm}phys::HingeConstraint::HingeConstraint (
\begin{DoxyParamCaption}
\item[{{\bf ActorRigid} $\ast$}]{ ActorA, }
\item[{{\bf ActorRigid} $\ast$}]{ ActorB, }
\item[{{\bf Vector3}}]{ PivotInA, }
\item[{{\bf Vector3}}]{ PivotInB, }
\item[{{\bf Vector3}}]{ AxisInA, }
\item[{{\bf Vector3}}]{ AxisInB, }
\item[{bool}]{ UseReferenceA = {\ttfamily false}}
...
\item[{{\bf ActorRigid} $\ast$}]{ ActorA, }
\item[{{\bf ActorRigid} $\ast$}]{ ActorB, }
\item[{{\bf Vector3}}]{ VectorA, }
\item[{{\bf Vector3}}]{ VectorB, }
\item[{{\bf Quaternion}}]{ QuaternionA, }
\item[{{\bf Quaternion}}]{ QuaternionB, }
\item[{bool}]{ UseReferenceA = {\ttfamily false}}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{HingeConstraint}]{\setlength{\rightskip}{0pt plus 5cm}phys::HingeConstraint::HingeConstraint (
\begin{DoxyParamCaption}
\item[{btHingeConstraint $\ast$}]{ Constraint}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{GetParam}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Real} phys::HingeConstraint::GetParam (
\begin{DoxyParamCaption}
\item[{int}]{ num, }
...
\subsubsection[{SetParam}]{\setlength{\rightskip}{0pt plus 5cm}void phys::HingeConstraint::SetParam (
\begin{DoxyParamCaption}
\item[{int}]{ num, }
\item[{{\bf Real}}]{ value, }
\item[{int}]{ axis = {\ttfamily -\/1}}
