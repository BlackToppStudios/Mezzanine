...
This will iterate through each Actor in the container until it finds one with a matching \hyperlink{classNode}{Node}. This runs in linear time. \begin{DoxyReturn}{Returns}
