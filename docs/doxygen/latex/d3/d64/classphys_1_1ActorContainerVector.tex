...
This Removes all scene nodes from the \hyperlink{namespaceOgre}{Ogre} the graphics subsystem, and removes all bodies from the physics system if a \hyperlink{classphys_1_1World}{phys::World} is present. Then this sets up all actors with the new \hyperlink{classphys_1_1World}{World} unless it is NULL 
\begin{DoxyParams}{Parameters}
