...
\begin{Desc}
\item[\hyperlink{todo__todo000021}{Todo}]Possibly restructure this so that it'll detect ogre first, preventing a crash. At current this makes the physics manager depend on the graphicsmanager. \end{Desc}
