...
\subsubsection[{$\sim$PhysicsManager}]{\setlength{\rightskip}{0pt plus 5cm}phys::PhysicsManager::$\sim$PhysicsManager ()\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
...
\subsubsection[{GetActorOffset}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Vector3} phys::PhysicsManager::GetActorOffset (const {\bf Vector3WActor} \& {\em OffsetInfo})}}
...
\subsubsection[{GetAreaEffect}]{\setlength{\rightskip}{0pt plus 5cm}{\bf AreaEffect} $\ast$ phys::PhysicsManager::GetAreaEffect ({\bf String} {\em Name})}}
...
Definition at line 552 of file physicsmanager.cpp.
...
Definition at line 535 of file physicsmanager.cpp.
