...
Definition at line 65 of file terrainmanager.h.
...
Retrieves a \hyperlink{classMezzanine_1_1MeshTerrain}{MeshTerrain} from the list of terrains. 
...
\begin{Desc}
\item[\hyperlink{todo__todo000032}{Todo}]When adding more types of terrains, it should be remembered that code should be added to clear the extra vectors. \end{Desc}
