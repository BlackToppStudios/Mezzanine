...
\begin{DoxyExceptions}{Exceptions}
{\em A} & \hyperlink{classphys_1_1Exception}{phys::Exception} with the message \char`\"{}Could not \{FailedTo\} during \{ClassName\} \mbox{[}De\mbox{]}Serialization.\char`\"{}\char`\"{}Could not \{FailedTo\} during \{ClassName\} \mbox{[}De\mbox{]}Serialization.\char`\"{} \\
\hline
\end{DoxyExceptions}
