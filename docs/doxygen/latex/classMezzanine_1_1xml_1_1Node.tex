...
\begin{Desc}
\item[\hyperlink{todo__todo000062}{Todo}]Investigate this more deeply. \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000060}{Todo}]Not all nodes can be added to other nodes, we need to figure it out and put it here. \end{Desc}
...
\end{DoxyParams}
\begin{Desc}
\item[\hyperlink{todo__todo000061}{Todo}]Not all nodes can be added to other nodes, we need to figure it out and put it here. \end{Desc}
\begin{DoxyReturn}{Returns}
A \hyperlink{classMezzanine_1_1xml_1_1Node}{Node} representing the freshly added \hyperlink{classMezzanine_1_1xml_1_1Node}{Node}, or an empty \hyperlink{classMezzanine_1_1xml_1_1Node}{Node} if there was an error. 
\end{DoxyReturn}
