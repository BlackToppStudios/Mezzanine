...
\begin{DoxyReturn}{Returns}
Returns a \hyperlink{classvector3}{vector3} containing the half extents of this cylinder. 
\end{DoxyReturn}
...
\begin{DoxyReturn}{Returns}
Returns a \hyperlink{classvector3}{vector3} containing the half extents with the margin added to each axis. 
\end{DoxyReturn}
