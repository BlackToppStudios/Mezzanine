...
\subsubsection[{ResizingInfo}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T $>$ {\bf phys::UI::ResizingInfo}$<$ T $>$::{\bf ResizingInfo} (T {\em TheObject}, \/  UI::ResizeableAnchor {\em RA}, \/  UI::ResizeableTether {\em RT}, \/  {\bf Vector2} {\em Off})\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
