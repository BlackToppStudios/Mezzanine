...
\index{phys::internal@{phys::internal}!GetNameOfEventFrom@{GetNameOfEventFrom}}
\index{GetNameOfEventFrom@{GetNameOfEventFrom}!phys::internal@{phys::internal}}
\subsubsection[{GetNameOfEventFrom}]{\setlength{\rightskip}{0pt plus 5cm}{\bf String} phys::internal::GetNameOfEventFrom (RawEvent $\ast$ {\em event})}}
