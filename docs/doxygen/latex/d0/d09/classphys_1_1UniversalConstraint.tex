...
\begin{center}
\leavevmode
\includegraphics[height=3.000000cm]{d0/d09/classphys_1_1UniversalConstraint}
\end{center}
\end{figure}
...
Definition at line 391 of file constraint.h.
...
\subsubsection[{UniversalConstraint}]{\setlength{\rightskip}{0pt plus 5cm}phys::UniversalConstraint::UniversalConstraint (
\begin{DoxyParamCaption}
\item[{btUniversalConstraint $\ast$}]{ Constraint}
