...
typedef void $\ast$($\ast$ {\bfseries phys::xml::AllocationFunction} )(size\_\-t size)}
...
typedef void($\ast$ {\bfseries phys::xml::deAllocationFunction} )(void $\ast$ptr)}
...
void PHYS\_\-LIB {\bfseries phys::xml::SetMemory\_\-management\_\-functions} (AllocationFunction allocate, deAllocationFunction deallocate)}
...
AllocationFunction PHYS\_\-LIB {\bfseries phys::xml::GetMemoryAllocationFunction} ()}
...
deAllocationFunction PHYS\_\-LIB {\bfseries phys::xml::GetMemoryDeallocationFunction} ()}
