...
\begin{DoxyParams}{Parameters}
\item[{\em snode}]Pointer to the \hyperlink{namespaceOgre}{Ogre} SceneNode this class is based on. \item[{\em manager}]Pointer to the manager that this node is to be used in. \end{DoxyParams}
