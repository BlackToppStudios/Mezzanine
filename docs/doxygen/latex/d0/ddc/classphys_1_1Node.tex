...
\subsubsection[{GetName}]{\setlength{\rightskip}{0pt plus 5cm}{\bf String} \& phys::Node::GetName ()}}
...
\subsubsection[{SetAutoTracking}]{\setlength{\rightskip}{0pt plus 5cm}void phys::Node::SetAutoTracking ({\bf ActorBase} $\ast$ {\em Actor}, \/  {\bf Vector3} {\em Offset} = {\ttfamily {\bf Vector3}()})}}
...
\index{phys::Node@{phys::Node}!SetAutoTracking@{SetAutoTracking}}
\index{SetAutoTracking@{SetAutoTracking}!phys::Node@{phys::Node}}
\subsubsection[{SetAutoTracking}]{\setlength{\rightskip}{0pt plus 5cm}void phys::Node::SetAutoTracking ({\bf Node} $\ast$ {\em node}, \/  {\bf Vector3} {\em Offset} = {\ttfamily {\bf Vector3}()})}}
