...
function FixNames
{
	...
	sed -i -e 's|ReSet|Reset|g' $1
	sed -i -e 's|_Name(name)|_Name(Name)|g' $1
	sed -i -e 's|internal::XPathQueryInternal|internal::XPathQueryImpl|g' $1
	sed -i -e 's|deAllocationFunction MEZZ_LIB GetMemoryDeallocationFunction();|deAllocationFunction MEZZ_LIB GetMemoryDeallocationFunction();\n}\n//Name spaces end here|g' $1
	###############################
