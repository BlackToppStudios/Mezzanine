...
class _OgreSampleClassExport Sample_Tessellation : public SdkSample
{
 ...
 protected:
    ...
    void setupContent()
    {
        ...
        MaterialPtr tMat = std::static_pointer_cast<Material>( MaterialManager::getSingleton().createOrRetrieve("Ogre/TessellationExample", ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME).first );
        tMat->compile();
