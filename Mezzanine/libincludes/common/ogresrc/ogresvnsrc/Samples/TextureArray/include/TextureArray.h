...
protected:
    ...
    void setupContent()
    {
        ...
        MaterialPtr texArrayMat = std::static_pointer_cast<Material>( matMgr.createOrRetrieve("Examples/TextureArray", ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME).first );
        texArrayMat->compile();
