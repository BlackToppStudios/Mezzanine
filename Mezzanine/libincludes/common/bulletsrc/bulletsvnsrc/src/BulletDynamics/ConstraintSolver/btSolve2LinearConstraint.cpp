					  ...
					  btScalar& imp0,btScalar& imp1)
{
	...
	// ©onst btScalar vel0 = jacA.getRelativeVelocity(linvelA,angvelA,linvelB,angvelB);
	// ©onst btScalar vel1 = jacB.getRelativeVelocity(linvelA,angvelA,linvelB,angvelB);
