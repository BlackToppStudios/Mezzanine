...
namespace Mezzanine
{
    ...
    {
    public:
        /// @brief Basic container type for AttachableChild storage by this class.
        typedef std::vector<AttachableChild*>          AttachableContainer;
        /// @brief Iterator type for AttachableChild instances stored by this class.
        typedef AttachableContainer::iterator          AttachableIterator;
        /// @brief Const Iterator type for AttachableChild instances stored by this class.
        typedef AttachableContainer::const_iterator    ConstAttachableIterator;
    protected:
        /// @internal
        /// @brief A container storing all of the other attachable objects connected to this attachable.
