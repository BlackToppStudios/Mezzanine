    ...
    namespace Network
    {
        ...
        sockaddr_storage ConvertToSocketStorage(const SystemAddress& MezzAddr)
        {
            ...
            if( Protocol == Network::NLP_IPv4 ) {
                ...
                MEZZ_EXCEPTION(Exception::PARAMETERS_EXCEPTION,"Unknown or invalid address type attempting to be converted to Berkeley socket type.");
            }
            return Ret;
        }
        ...
        SystemAddress ConvertToSystemAddress(const sockaddr_storage& BerkAddr)
        {
            ...
            if( BerkAddr.ss_family == AF_INET ) {
                ...
                MEZZ_EXCEPTION(Exception::PARAMETERS_EXCEPTION,"Unknown or invalid socket address type attempting to be converted to Mezzanine address.");
            }
            return Ret;
        }
        ...
        SocketDescription ConvertToSocketDescription(const sockaddr_storage& BerkAddr)
        {
            ...
            if( BerkAddr.ss_family == AF_INET ) {
                ...
                MEZZ_EXCEPTION(Exception::PARAMETERS_EXCEPTION,"Unknown or invalid socket address type attempting to be converted to Mezzanine socket description.");
            }
            return Ret;
        }
        ...
        Boole PlatformSocket::Bind(const UInt16 Port)
        {
            ...
            if( Result != 0 ) {
                MEZZ_EXCEPTION(Exception::INTERNAL_EXCEPTION,gai_strerror(Result));
            }
        ...
        Boole PlatformSocket::Bind(sockaddr* Address, const int Length)
        {
            #if defined(MEZZ_WINDOWS)
        ...
        Boole PlatformSocket::Connect(sockaddr* Address, const int Length)
        {
            #if defined(MEZZ_WINDOWS)
        ...
        void PlatformSocket::ThrowError(const int ErrorCode)
        {
            ...
            #endif
            MEZZ_EXCEPTION(Exception::INTERNAL_EXCEPTION,ErrorMsg);
        }
