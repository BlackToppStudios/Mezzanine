...
namespace Mezzanine
{
    namespace UI
    {
        ...
        void GridContainer::UpdateVisibleChildren()
        {
        ...
        void GridContainer::SetPageWidget(HorizontalScrollbar* HPage, VerticalScrollbar* VPage)
        {
            //this->PageInfo = new DualScrollbarPageInterpreter(HPage,VPage);
        }

        void GridContainer::SetPageWidget(Spinner* Page)
        {
            //this->PageInfo = new SpinnerPageInterpreter(Page);
        }
