...
*/
#ifndef _uiverticalscrollbar_h
#define _uiverticalscrollbar_h
...
namespace Mezzanine
{
    namespace UI
    {
        ...
        {
        public:
            /// @brief String containing the type name for this class: "VerticalScrollbar".
            static const String TypeName;
        protected:
            friend class VerticalScrollbarFactory;
        ...
        ///////////////////////////////////////////////////////////////////////////////
        /// @brief This is the factory implementation for VerticalScrollbar widgets.
        /// @details
        ///////////////////////////////////////
        class MEZZ_LIB VerticalScrollbarFactory : public WidgetFactory
        {
        public:
            ...
            /// @param Parent The screen the created VerticalScrollbar will belong to.
            /// @return Returns a pointer to the created VerticalScrollbar.
            virtual VerticalScrollbar* CreateVerticalScrollbar(const XML::Node& XMLNode, Screen* Parent);
