...
namespace Mezzanine
{
    namespace UI
    {
        ...
        const EventNameType RadioButtonGroup::EventGroupButtonSelected = "GroupButtonSelected";
        ...
        void RadioButtonGroup::_NotifyButtonSelected(RadioButton* Selected)
        {
            if( this->CurrentSelection != Selected ) {
                ...
                WidgetEventPtr Args( new WidgetEvent( RadioButtonGroup::EventGroupButtonSelected,Selected->GetName()) );
