...
namespace Mezzanine
{
    namespace UI
    {
        ...
        /// @details
        ///////////////////////////////////////
        class MEZZ_LIB MenuWindow : public Window
        {
            protected:
                friend class Menu;
            ...
            //public:
                ...
                /// @param PScreen The parent layer this window belongs to.
                MenuWindow(ConstString& Name, const Rect& RendRect, UI::Menu* TheMenu, Screen* PScreen);
            ...
            public:
                ...
                /// @param RendRect The Rect representing the position and size of the button.
                /// @return Returns a pointer to the created Back Button.
                virtual Button* CreateBackButton(const Rect& RendRect);
                ...
                /// @return Returns a pointer to the created Back Button.
                virtual Button* CreateBackButton(const Rect& RendRect, const Whole& Glyph, const String& Text);
                /// @brief Creates a back button that is a text button for this window.
                /// @details The name is autogenerated to be the name of the window + "back".
                /// This function will do nothing if the back button has already been created.
                /// @param RendRect The Rect representing the position and size of the button.
                ...
                /// @param Text The text to set for the button.
                /// @return Returns a pointer to the created Back Button.
                virtual Button* CreateBackButton(const Rect& RendRect, const Real& LineHeight, const String& Text);
                ...
                /// @param RendRect The Rect representing the position and size of the button.
                virtual Button* CreateAccessorButton(ConstString& Name, const Rect& RendRect);
                ...
                /// @param Glyph The glyph set to use when generating the text for the button.
                /// @param Text The text to set for the button.
                virtual Button* CreateAccessorButton(ConstString& Name, const Rect& RendRect, const Whole& Glyph, const String& Text);
                /// @brief Creates a text button to be used for accessing child windows.
                /// @return Returns a pointer to the created button.
                /// @param Name The name of the button.
                /// @param RendRect The Rect representing the position and size of the button.
                /// @param LineHeight The lineheight you want the text to have in relative units.  This will automatically select the glyph and scale it for you.
                /// @param Text The text to set for the button.
                virtual Button* CreateAccessorButton(ConstString& Name, const Rect& RendRect, const Real& LineHeight, const String& Text);
                ...
                virtual MenuWindow* CreateChildMenuWindow(ConstString& Name, const Rect& RendRect, Button* Accessor);
