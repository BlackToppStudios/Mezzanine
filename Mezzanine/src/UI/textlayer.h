...
namespace Mezzanine
{
    namespace UI
    {
        ...
        public:
            ...
            typedef std::pair<bool,Integer>                         CharIndexPair;
            /// @brief An std::pair type used as a return for index-offset conversions.
            typedef std::pair<bool,Vector2>                         CharOffsetPair;
        protected:
            /// @internal
            ...
            /// @internal
            /// @brief The lineheight the text is to be in relative units.
            Real RelLineHeight;
            /// @internal
        ...
        public:
            ...
            virtual void SetTextScale(const Vector2& Scale);
            ...
            virtual const Vector2& GetTextScale() const;
            ...
            /// @brief Gets whether or not text from this layer will automatically scale on a screen size change.
            /// @return Returns a bool indicating whether or not this layer will automatically scale it's text.
            virtual bool GetAutoScaleText() const;
