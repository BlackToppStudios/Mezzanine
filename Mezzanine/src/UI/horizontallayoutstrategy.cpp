...
*/
#ifndef _uihorizontallayoutstrategy_cpp
#define _uihorizontallayoutstrategy_cpp
...
namespace Mezzanine
{
    namespace UI
    {
        HorizontalLayoutStrategy::HorizontalLayoutStrategy()
            {  }
        ...
        void HorizontalLayoutStrategy::Layout(const Rect& OldSelfRect, const Rect& NewSelfRect, const ChildContainer& ChildQuads)
        {
