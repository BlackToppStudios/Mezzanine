...
namespace Mezzanine
{
    ...
    std::ostream& operator << (std::ostream& stream, const Mezzanine::TypedConstraint& x)
    {
        Serialize(stream,x);
        return stream;
    }
    ...
    std::ostream& operator << (std::ostream& stream, const Mezzanine::DualTransformConstraint& x)
    {
        Serialize(stream,x);
        return stream;
    }
    ...
    std::ostream& operator << (std::ostream& stream, const Mezzanine::Generic6DofConstraint& x)
    {
        Serialize(stream,x);
        return stream;
    }
    ...
    std::ostream& operator << (std::ostream& stream, const Mezzanine::Generic6DofSpringConstraint& x)
    {
        Serialize(stream,x);
        return stream;
    }
    ...
    std::ostream& operator << (std::ostream& stream, const Mezzanine::HingeConstraint& x)
    {
        Serialize(stream,x);
        return stream;
    }
    ...
    std::ostream& operator << (std::ostream& stream, const Mezzanine::Point2PointConstraint& x)
    {
        Serialize(stream,x);
        return stream;
    }
