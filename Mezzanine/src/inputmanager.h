...
namespace Mezzanine
{
    ...
    {
        public:
            typedef std::vector< Input::Controller* >    ControllerContainer;
        ...
        protected:
            Input::Mouse* SystemMouse;
            Input::Keyboard* SystemKeyboard;
