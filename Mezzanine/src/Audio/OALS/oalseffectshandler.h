    ...
    namespace Audio
    {
        namespace OALS
        {
            ...
            public:
                ...
                virtual bool IsEffectSupported(const EffectType Type) const;
                ...
                virtual bool IsFilterSupported(const FilterType Type) const;
                ...
                virtual bool EffectPresetExists(const EffectType Type, const String& Name);
