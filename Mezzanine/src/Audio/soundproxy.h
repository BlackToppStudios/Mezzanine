...
namespace Mezzanine
{
    namespace Audio
    {
        ...
        public:
            ...
            /// @brief Sets whether or not sounds generated by this sound proxy will be emitted in a specified direction.
            /// @param Enable True to enable this sound proxy to direct it's audio, false to have it emit in all directions.
            virtual void SetDirectSound(Boolean Enable) = 0;
            /// @brief Gets whether or not this sound proxy is emitting in a specific direction.
            /// @return Returns true if this sound proxy is emitting in a specific direction, false if it's emitting in all directions.
            virtual Boolean IsDirectingSound() const = 0;
