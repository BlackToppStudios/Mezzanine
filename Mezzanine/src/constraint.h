...
namespace Mezzanine
{
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    class MEZZ_LIB TypedConstraint
    {
        protected:
            friend class World;
    ...
    ///////////////////////////////////////////////////////////////////////////////
    class MEZZ_LIB DualTransformConstraint : public TypedConstraint
    {
        public:
    ...
    ///////////////////////////////////////
    class MEZZ_LIB ConeTwistConstraint : public TypedConstraint
    {
        protected:
    ...
    ///////////////////////////////////////
    class MEZZ_LIB Point2PointConstraint : public TypedConstraint
    {
        protected:
            /// @brief Bullet constraint that this class encapsulates.
    ...
    /// @details This class is incomplete
    ///////////////////////////////////////
    class MEZZ_LIB SliderConstraint : public TypedConstraint
    {
        protected:
            /// @brief Bullet constraint that this class encapsulates.
    ...
    class MEZZ_LIB UniversalJointConstraint : public Generic6DofConstraint
    {
        protected:
            /// @brief Bullet constraint that this class encapsulates.
    ...
    std::ostream& MEZZ_LIB operator << (std::ostream& stream, const Mezzanine::TypedConstraint& x);
    ...
    std::istream& MEZZ_LIB operator >> (std::istream& stream, Mezzanine::TypedConstraint& x);
