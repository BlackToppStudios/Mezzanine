...
namespace Mezzanine
{
    ...
    private:
        ...
        /// @brief The world to perform queries in.
        World* ParentWorld;
        /// @brief True if the last Query yielded a meaningful Result.
        Boole ValidResult;
    public:
        /// @brief Blank constructor.
        /// @warning A world must be set before using this class.
        RayQueryTool();
        /// @brief Create a RayQueryTool ready for querying.
        /// @param QueryWorld The world in which to perform the ray queries.
        RayQueryTool(World* QueryWorld);

        ///////////////////////////////////////////////////////////////////////////////
        // Utility

        /// @brief Sets the World in which the ray query is to be performed.
        /// @param QueryWorld The world in which to perform the ray queries.
