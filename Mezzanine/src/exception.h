...
class  IOException : public ExceptionBase
{
    public:
        /// @brief Thrown when there was an issue with IO but very little was known about it.
        static const Int32 ExceptionCode = ExceptionBase::IO_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        IOException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
        ...
        virtual Int32 GetExceptionCode() const throw()
...
class  FileException : public IOException
{
    public:
        /// @brief Thrown when there is an unknown issue with a file
        static const Int32 ExceptionCode = IOException::IO_FILE_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        FileException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  FileReadException : public FileException
{
    public:
        /// @brief Thrown when a file could not be read and permissions seem to not be an issue (Filesystem/hardware issue?
        static const Int32 ExceptionCode = FileException::IO_FILE_READ_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        FileReadException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  FileWriteException : public FileException
{
    public:
        /// @brief Thrown when a file could not be written and perimssions seem not to be an issue
        static const Int32 ExceptionCode = FileException::IO_FILE_WRITE_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        FileWriteException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  FileNotFoundException : public FileException
{
    public:
        /// @brief Thrown when a file was expected to be there, but was not
        static const Int32 ExceptionCode = FileException::IO_FILE_NOT_FOUND_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        FileNotFoundException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  FilePermissionException : public FileException
{
    public:
        /// @brief Thrown when permission was denied to a file
        static const Int32 ExceptionCode = FileException::IO_FILE_PERMISSION_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        FilePermissionException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  DirectoryException : public IOException
{
    public:
        /// @brief Thrown when there is an unknown issue with a file
        static const Int32 ExceptionCode = IOException::IO_DIRECTORY_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        DirectoryException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  DirectoryReadException : public DirectoryException
{
    public:
        /// @brief Thrown when a directory could be read and it wasn't a permission issue
        static const Int32 ExceptionCode = DirectoryException::IO_DIRECTORY_READ_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        DirectoryReadException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  DirectoryWriteException : public DirectoryException
{
    public:
        /// @brief Thrown when a directory could be written to and it wasn't a permission issue
        static const Int32 ExceptionCode = DirectoryException::IO_DIRECTORY_WRITE_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        DirectoryWriteException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  DirectoryNotFoundException : public DirectoryException
{
    public:
        /// @brief Thrown when a directory was expected to be there, but was not
        static const Int32 ExceptionCode = DirectoryException::IO_DIRECTORY_NOT_FOUND_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        DirectoryNotFoundException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  DirectoryPermissionException : public DirectoryException
{
    public:
        /// @brief Thrown when permission is denied to a directory
        static const Int32 ExceptionCode = DirectoryException::IO_DIRECTORY_PERMISSION_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        DirectoryPermissionException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  NetworkException : public IOException
{
    public:
        /// @brief Thrown when something unknown causes network IO to fail
        static const Int32 ExceptionCode = IOException::IO_NETWORK_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        NetworkException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  NetworkReadException : public NetworkException
{
    public:
        /// @brief Thrown when data could not be read from the network (downloads)
        static const Int32 ExceptionCode = NetworkException::IO_NETWORK_READ_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        NetworkReadException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  NetworkWriteException : public NetworkException
{
    public:
        /// @brief Thrown when data could not be read from the network (iloads)
        static const Int32 ExceptionCode = NetworkException::IO_NETWORK_WRITE_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        NetworkWriteException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  NetworkNotFoundException : public NetworkException
{
    public:
        /// @brief Thrown when no network connection is available
        static const Int32 ExceptionCode = NetworkException::IO_NETWORK_NOT_FOUND_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        NetworkNotFoundException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  NetworkURLException : public NetworkException
{
    public:
        /// @brief Thrown when an address is invalid or could not be found
        static const Int32 ExceptionCode = NetworkException::IO_NETWORK_URL_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        NetworkURLException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  NetworkPermissionException : public NetworkException
{
    public:
        /// @brief Thrown when permision was denied to a network interface or network resource
        static const Int32 ExceptionCode = NetworkException::IO_NETWORK_PERMISSION_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        NetworkPermissionException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  IOWriteException : public IOException
{
    public:
        /// @brief Thrown when a write is happening but something has prevented the underlying code from knowing what was writing
        static const Int32 ExceptionCode = IOException::IO_WRITE_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        IOWriteException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  IOReadException : public IOException
{
    public:
        /// @brief Thrown when a read is happening but something has prevented the underlying code from knowing what was reading
        static const Int32 ExceptionCode = IOException::IO_READ_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        IOReadException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
/// @details When catching this in java look for @a java.lang.XXXXX
///////////////////
class  InstanceIdentityException : public Exception
{
    public:
        /// @brief Thrown when an unknown error with using an Identifier and it is invalid
        static const Int32 ExceptionCode = Exception::II_EXCEPTION;
        ...
        InstanceIdentityException(
                ...
                const String& SrcFile,
                const Int32& FileLine)
            : Exception(TypeName, JavaTypeName, Message, SrcFunction, SrcFile, FileLine)
            {}
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        InstanceIdentityException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
            :  Exception("InstanceIdentityException", "java/lang/XXXXX", Message, SrcFunction, SrcFile, FileLine)
            {}
...
class  InstanceIdentityInvalidException : public InstanceIdentityException
{
    public:
        /// @brief Thrown when the identity string wasn't valid at all
        static const Int32 ExceptionCode = InstanceIdentityException::II_IDENTITY_INVALID_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        InstanceIdentityInvalidException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  InstanceIdentityNotFoundException : public InstanceIdentityException
{
    public:
        /// @brief Thrown when the requested identity could not be found
        static const Int32 ExceptionCode = InstanceIdentityException::II_IDENTITY_NOT_FOUND_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        InstanceIdentityNotFoundException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  InstanceIdentityDuplicateException : public InstanceIdentityException
{
    public:
        /// @brief Thrown when duplicates of teh same identity string exist
        static const Int32 ExceptionCode = InstanceIdentityException::II_DUPLICATE_IDENTITY_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        InstanceIdentityDuplicateException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  MemoryManagementException : public Exception
{
    public:
        /// @brief Thrown when an unknown memory management exception occurs
        static const Int32 ExceptionCode = Exception::MM_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        MemoryManagementException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
            :  Exception("MemoryManagementException", "java/lang/XXXXX", Message, SrcFunction, SrcFile, FileLine)
            {}
...
class  OutOfMemoryException : public MemoryManagementException
{
    public:
        /// @brief Thrown when A memory allocation was attempted and failed
        static const Int32 ExceptionCode = MemoryManagementException::MM_OUT_OF_MEMORY_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        OutOfMemoryException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  MemoryOutOfBoundsException : public MemoryManagementException
{
    public:
        /// @brief Thrown when attempted to access something that really should note be accessed
        static const Int32 ExceptionCode = MemoryManagementException::MM_OUT_OF_BOUNDS_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        MemoryOutOfBoundsException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  SyntaxErrorException : public Exception
{
    public:
        /// @brief Thrown when some kind of syntax exception
        static const Int32 ExceptionCode = Exception::SYNTAX_ERROR_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        SyntaxErrorException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
            :  Exception("SyntaxErrorException", "java/lang/XXXXX", Message, SrcFunction, SrcFile, FileLine)
            {}
...
class  SyntaxErrorXMLException : public SyntaxErrorException
{
    public:
        /// @brief Thrown when and XML document is being parsed but is invalid
        static const Int32 ExceptionCode = SyntaxErrorException::SYNTAX_ERROR_EXCEPTION_XML;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        SyntaxErrorXMLException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  SyntaxErrorXPathException : public SyntaxErrorException
{
    public:
        /// @brief Thrown when an XPath query is being parsed but is invalid
        static const Int32 ExceptionCode = SyntaxErrorException::SYNTAX_ERROR_EXCEPTION_XPATH;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        SyntaxErrorXPathException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  SyntaxErrorLuaException : public SyntaxErrorException
{
    public:
        /// @brief Thrown when lua code in incorrect
        static const Int32 ExceptionCode = SyntaxErrorException::SYNTAX_ERROR_EXCEPTION_LUA;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        SyntaxErrorLuaException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  ScriptException : public Exception
{
    public:
        /// @brief Thrown when an unknown error happens with a script
        static const Int32 ExceptionCode = Exception::SCRIPT_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        ScriptException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
            :  Exception("ScriptException", "java/lang/XXXXX", Message, SrcFunction, SrcFile, FileLine)
            {}
...
class  ScriptLuaException : public ScriptException
{
    public:
        /// @brief Thrown when an unknown error happens in a Lua script
        static const Int32 ExceptionCode = ScriptException::SCRIPT_EXCEPTION_LUA;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        ScriptLuaException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  ScriptLuaYieldException : public ScriptLuaException
{
    public:
        /// @brief Thrown when Lua returns a yield and it should not have
        static const Int32 ExceptionCode = ScriptLuaException::SCRIPT_EXCEPTION_LUA_YIELD;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        ScriptLuaYieldException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  ScriptLuaRuntimeException : public ScriptLuaException
{
    public:
        /// @brief Thrown when a Lua script has a runtime error
        static const Int32 ExceptionCode = ScriptLuaException::SCRIPT_EXCEPTION_LUA_RUNTIME;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        ScriptLuaRuntimeException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  ScriptLuaErrErrException : public ScriptLuaException
{
    public:
        /// @brief Thrown when Lua has an error handling an error
        static const Int32 ExceptionCode = ScriptLuaException::SCRIPT_EXCEPTION_LUA_ERRERR;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        ScriptLuaErrErrException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  ParametersException : public Exception
{
    public:
        /// @brief Thrown when parameters are checked at runtime and found invalid
        static const Int32 ExceptionCode = Exception::PARAMETERS_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        ParametersException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
            :  Exception("ParametersException", "java/lang/XXXXX", Message, SrcFunction, SrcFile, FileLine)
            {}
...
class  ParametersCastException : public ParametersException
{
    public:
        /// @brief Thrown when a pointer parameter is checked at runtime and cannot be cast as expected
        static const Int32 ExceptionCode = ParametersException::PARAMETERS_CAST_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        ParametersCastException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  ParametersRangeException : public ParametersException
{
    public:
        /// @brief Thrown when a passed parameter is checked at runtime and not in the expected range
        static const Int32 ExceptionCode = ParametersException::PARAMETERS_RANGE_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        ParametersRangeException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
...
class  ArithmeticException : public Exception
{
    public:
        /// @brief Thrown when Math has failed
        static const Int32 ExceptionCode = Exception::ARITHMETIC_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        ArithmeticException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
            :  Exception("ArithmeticException", "java/lang/XXXXX", Message, SrcFunction, SrcFile, FileLine)
            {}
...
class  InvalidVersionException : public Exception
{
    public:
        /// @brief Thrown when a version is accessed/parsed/required and it cannot work correctly or is missing
        static const Int32 ExceptionCode = Exception::INVALID_VERSION_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        InvalidVersionException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
            :  Exception("InvalidVersionException", "java/lang/XXXXX", Message, SrcFunction, SrcFile, FileLine)
            {}
...
class  InvalidStateException : public Exception
{
    public:
        /// @brief Thrown when the available information should have worked but failed for unknown reasons
        static const Int32 ExceptionCode = Exception::INVALID_STATE_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        InvalidStateException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
            :  Exception("InvalidStateException", "java/lang/XXXXX", Message, SrcFunction, SrcFile, FileLine)
            {}
...
class  RenderingAPIException : public Exception
{
    public:
        /// @brief Thrown when the graphics card/DirectX/OpenGL fail
        static const Int32 ExceptionCode = Exception::RENDERINGAPI_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        RenderingAPIException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
            :  Exception("RenderingAPIException", "java/lang/XXXXX", Message, SrcFunction, SrcFile, FileLine)
            {}
...
class  RuntimeAssertionException : public Exception
{
    public:
        /// @brief Thrown when a rutime assertion could have been Thrown
        static const Int32 ExceptionCode = Exception::RT_ASSERTION_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        RuntimeAssertionException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
            :  Exception("RuntimeAssertionException", "java/lang/XXXXX", Message, SrcFunction, SrcFile, FileLine)
            {}
...
class  InternalException : public Exception
{
    public:
        /// @brief Thrown when an unknown internal error occurred
        static const Int32 ExceptionCode = Exception::INTERNAL_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        InternalException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
            :  Exception("InternalException", "java/lang/XXXXX", Message, SrcFunction, SrcFile, FileLine)
            {}
...
class  NotImplementedException : public Exception
{
    public:
        /// @brief Thrown when we just have not coded a thing yet, but we knew what the API should look like
        static const Int32 ExceptionCode = Exception::NOT_IMPLEMENTED_EXCEPTION;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        NotImplementedException(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
            :  Exception("NotImplementedException", "java/lang/XXXXX", Message, SrcFunction, SrcFile, FileLine)
            {}
...
class  InvalidAssignment : public Exception
{
    public:
        /// @brief Thrown when a complex class is assigned to itself or other invalid assignments occur
        static const Int32 ExceptionCode = Exception::INVALID_ASSIGNMENT;
        ...
        /// @param FileLine The line on the named file from which this originated.
        /// @warning This probably shouldn't be called directly. Use @ref MEZZ_EXCEPTION if possible.
        InvalidAssignment(const String& Message, const String& SrcFunction, const String& SrcFile, const Int32& FileLine)
            :  Exception("InvalidAssignment", "java/lang/XXXXX", Message, SrcFunction, SrcFile, FileLine)
            {}
