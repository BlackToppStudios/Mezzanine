...
namespace Mezzanine
{
    ...
    public:
        ...
        static Boole CreateDirectory(const String& DirectoryPath);
        ...
        static Boole DoesDirectoryExist(const String& DirectoryPath);
        ...
        static Boole CreateDirectoryPath(const String& DirectoryPath);
