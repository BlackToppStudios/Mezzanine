...
#ifndef noiseenumerations_h
#define noiseenumerations_h

namespace Mezzanine
{
    namespace Noise
    {
        /// @brief Enumerates the noise quality.
        enum NoiseQuality
        {
            NQ_Fast = 0,    /*!< Generates coherent noise quickly.  When a coherent-noise function with
                                ...
                                boundaries. */
            NQ_Standard = 1,/*!< Generates standard-quality coherent noise.  When a coherent-noise
            ...
            NQ_Best = 2     /*!< Generates the best-quality coherent noise.  When a coherent-noise
                                function with this quality setting is used to generate a bump-map
