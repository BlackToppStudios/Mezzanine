...
#ifndef noisemodelplane_cpp
#define noisemodelplane_cpp
...
namespace Mezzanine
{
    namespace Noise
    {
        namespace Model
        {
            ...
            PreciseReal Plane::GetValue(const PreciseReal X, const PreciseReal Z) const
            {
                assert(this->m_pModule != NULL );

                return this->m_pModule->GetValue(X, 0, Z);
            }
        }//Model
    }//Noise
}//Mezzanine
