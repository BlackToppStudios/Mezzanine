...
#ifndef noisemoduleconst_h
#define noisemoduleconst_h
...
namespace Mezzanine
{
    namespace Noise
    {
        namespace Module
        {
            ...
            /// @brief Default constant value for the Noise::Module::Const noise module.
            const PreciseReal DEFAULT_CONST_VALUE = 0.0;
            ...
            public:
                /// @brief Constructor.
                /// @remarks The default constant value is set to Noise::Module::DEFAULT_CONST_VALUE.
                Const();

                /// @brief Returns the constant output value for this noise module.
                /// @return Returns the constant output value for this noise module.
                PreciseReal GetConstValue() const
                {
                ...
                /// @brief Sets the constant output value for this noise module.
                /// @param ConstValue The constant output value for this noise module.
                void SetConstValue(const PreciseReal ConstValue)
                {
