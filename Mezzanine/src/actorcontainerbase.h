...
namespace Mezzanine
{
    ...
    /// be usable with the Mezzanine::World for tracking in game objects. There are several reasons why this
    ...
    /// The world will use one of these containers to store all of the actors for tracking purposes
    /// Since  \n\n
    ...
    /// movement functions. For the container that the Mezzanine::World keeps it should be assume that the
    ...
    class MEZZ_LIB ActorContainerBase
    {
        protected:
            /// @internal
        ...
        public:
            ...
            /// @warning This will cause issues if used with a container attached to a valid Mezzanine::World. Use World::RemoveActor instead.
            ...
            /// @return This returns a Mezzanine::String
