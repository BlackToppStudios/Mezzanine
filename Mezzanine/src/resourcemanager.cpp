...
namespace Mezzanine
{
    ...
    Boole ResourceManager::CreateDirectory(const String& DirectoryPath)
    {
        #ifdef WINDOWS
    ...
    Boole ResourceManager::DoesDirectoryExist(const String& DirectoryPath)
    {
        struct stat st;
    ...
    Boole ResourceManager::CreateDirectoryPath(const String& DirectoryPath)
    {
        Boole Result = true;
