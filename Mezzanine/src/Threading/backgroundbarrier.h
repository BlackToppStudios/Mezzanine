...
*/
#ifndef _background_barrier_cpp_barrier_h
#define _background_barrier_cpp_barrier_h

#include "datatypes.h"

/// @file
/// @brief The declaration of the @ref Mezzanine::Threading::BackgroundBarrier Barrier synchronization primitive
...
namespace Mezzanine
{
    namespace Threading
    {
        ...
        /// without maxing out a CPU at the cost of latency.
        class MEZZ_LIB BackgroundBarrier
        {
            ...
            public:
                ...
                BackgroundBarrier(const Int32& SynchThreadCount);
