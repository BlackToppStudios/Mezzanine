...
static int _proxy__wrap_new_XMLStreamWrapper(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_XMLStreamWrapper);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
...
static swig_lua_class _wrap_class_XMLStreamWrapper = { "XMLStreamWrapper", "XMLStreamWrapper", &SWIGTYPE_p_Mezzanine__XML__XMLStreamWrapper,_proxy__wrap_new_XMLStreamWrapper, swig_delete_XMLStreamWrapper, swig_XMLStreamWrapper_methods, swig_XMLStreamWrapper_attributes, &swig_XMLStreamWrapper_Sf_SwigStatic, swig_XMLStreamWrapper_meta, swig_XMLStreamWrapper_bases, swig_XMLStreamWrapper_base_names };
