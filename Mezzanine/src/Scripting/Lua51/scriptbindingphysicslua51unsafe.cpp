...
#define SWIG_name      "MezzaninePhysics"
#define SWIG_init      luaopen_MezzaninePhysics
#define SWIG_init_user luaopen_MezzaninePhysics_user

#define SWIG_LUACODE   luaopen_MezzaninePhysics_luacode
