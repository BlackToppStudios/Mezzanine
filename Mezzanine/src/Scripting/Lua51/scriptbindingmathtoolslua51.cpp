...
static int _proxy__wrap_new_AxisAlignedQuad(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_AxisAlignedQuad);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_AxisAlignedQuad_attributes[] = {
...
static swig_lua_method swig_AxisAlignedQuad_methods[]= {
    { "OverlapsWith", _wrap_AxisAlignedQuad_OverlapsWith},
    { "__eq", _wrap_AxisAlignedQuad___eq},
    {0,0}
};
static swig_lua_method swig_AxisAlignedQuad_meta[] = {
    { "__eq", _wrap_AxisAlignedQuad___eq},
    {0,0}
};

static swig_lua_attribute swig_AxisAlignedQuad_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_AxisAlignedQuad_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_AxisAlignedQuad_Sf_SwigStatic_methods[]= {
    { "DropAxisToCreateVector2", _wrap_AxisAlignedQuad_DropAxisToCreateVector2},
    {0,0}
};
static swig_lua_class* swig_AxisAlignedQuad_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_AxisAlignedQuad_Sf_SwigStatic = {
    "AxisAlignedQuad",
    swig_AxisAlignedQuad_Sf_SwigStatic_methods,
    swig_AxisAlignedQuad_Sf_SwigStatic_attributes,
    swig_AxisAlignedQuad_Sf_SwigStatic_constants,
    swig_AxisAlignedQuad_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_AxisAlignedQuad_bases[] = {0};
