...
namespace Mezzanine
{
    ...
    namespace BinaryTools
    {
        ...
        public:
            ...
            explicit BinaryBuffer(const Whole PredeterminedSize);
            ...
            explicit BinaryBuffer(const String& DataString, const Boole IsBase64 = true);
            ...
            String ToString();
            /// @brief Even though this class is intended to have its internals modified directly in some cases, In normal cases accessor are nice to have.
            ...
            /// @details An easier way to call @ref Concatenate(const Byte*, const Whole)
