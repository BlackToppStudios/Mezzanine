...
namespace Mezzanine
{
    namespace Graphics
    {
        ...
        /// @brief This class is used to store the internal structures needed by the Material class.
        /// @details Specifically, this class stores a shared pointer to the Ogre Material and only
        /// exists because shared pointers can't be forward declared without compromising how they
        /// work.
        ///////////////////////////////////////
        class MEZZ_LIB InternalMaterialData
        {
            public:
