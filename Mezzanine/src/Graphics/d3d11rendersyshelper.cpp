...
*/
#ifndef _graphicsd3d11rendersyshelper_cpp
#define _graphicsd3d11rendersyshelper_cpp

#include "Graphics/d3d11rendersyshelper.h.cpp"
...
namespace Mezzanine
{
    namespace Graphics
    {
        ...
        {
            if( RSPlugin == NULL ) {
                RSPlugin = new Ogre::D3D11Plugin();
                Ogre::Root::getSingletonPtr()->installPlugin( RSPlugin );
            }else{
                MEZZ_EXCEPTION(Exception::INVALID_STATE_EXCEPTION,"The Direct3D11 render system has already been created.")
            }
        }
