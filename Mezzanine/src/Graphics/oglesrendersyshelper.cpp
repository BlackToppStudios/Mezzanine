...
*/
#ifndef _graphicsoglesrendersyshelper_cpp
#define _graphicsoglesrendersyshelper_cpp

#include "Graphics/oglesrendersyshelper.h.cpp"
...
namespace Mezzanine
{
    namespace Graphics
    {
        ...
        {
            if( RSPlugin == NULL ) {
                RSPlugin = new Ogre::GLESPlugin();
                Ogre::Root::getSingletonPtr()->installPlugin( RSPlugin );
            }else{
                MEZZ_EXCEPTION(Exception::INVALID_STATE_EXCEPTION,"The OpenGLES render system has already been created.")
            }
        }
