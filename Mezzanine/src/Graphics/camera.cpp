...
*/
#ifndef _graphicscamera_cpp
#define _graphicscamera_cpp
...
/// @file camera.h
/// @brief Declaration of the Mezzanine::Graphics::Camera class
...
std::ostream& operator << (std::ostream& stream, const Mezzanine::Graphics::Camera& Ev)
{
...
Mezzanine::XML::Node& operator >> (const Mezzanine::XML::Node& OneNode, Mezzanine::Graphics::Camera& Ev)
{
    if ( Mezzanine::String(OneNode.Name())==Mezzanine::String("Camera") )
    {
        if(OneNode.GetAttribute("Version").AsInt() == 1)
        {
            Ev.SetCameraType(static_cast<Mezzanine::Graphics::Camera::ProjectionType>(OneNode.GetAttribute("CameraPerspective").AsInt()));
