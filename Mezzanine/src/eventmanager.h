...
namespace Mezzanine
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Every frame the OS must be queried for changes to the state, this does that querying on behalf of an eventmanager.
    /// @details
    ///////////////////////////////////////
    class MEZZ_LIB EventPumpWorkUnit : public Threading::DefaultWorkUnit
    {
    protected:
        /// @internal
        /// @brief The Manager this does the work for.
    ...
    public:
        ...
        /// @brief Gets the work unit responsible for pumping events from the OS.
