...
namespace Mezzanine
{
    namespace Input
    {
        ...
        protected:
            ...
            /// @internal
            /// @brief Adds MetaCodes belonging to all the buttons that are currently pressed for this device.
        ...
        public:
            ...
            /// @copydoc Device::_Update(const MetaCodeContainer& DeltaCodes, MetaCodeContainer& GeneratedCodes)
